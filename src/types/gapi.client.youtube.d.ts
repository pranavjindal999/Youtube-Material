//NPM package for this type is wrong. These types are slightly modified types copied from '@types/gapi.youtube'.
...
declare namespace gapi.client.youtube {
  ...
  const i18nRegions: {
    list(object: {
      ...
      fields?: string;
      hl?: string;
    }): HttpRequest<GoogleApiYouTubei18nRegionsResource>;
  };
}

interface GoogleApiYouTubei18nRegionsResource {
  kind: string;
  etag: string;
  items: {
    kind: string;
