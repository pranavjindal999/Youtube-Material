...
I("isoWeekday","E"),L("day",11),L("weekday",11),L("isoWeekday",11),Y("d",Kd),Y("e",Kd),Y("E",Kd),Y("dd",function(a,b){return b.weekdaysMinRegex(a)}),Y("ddd",function(a,b){return b.weekdaysShortRegex(a)}),Y("dddd",function(a,b){return b.weekdaysRegex(a)}),ba(["dd","ddd","dddd"],function(a,b,c,d){var e=c._locale.weekdaysParse(a,d,c._strict);null!=e?b.d=e:l(c).invalidWeekday=a}),ba(["d","e","E"],function(a,b,c,d){b[d]=t(a)});var me="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),ne="Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),oe="Su_Mo_Tu_We_Th_Fr_Sa".split("_"),pe=Vd,qe=Vd,re=Vd;T("H",["HH",2],0,"hour"),T("h",["hh",2],0,Qa),T("k",["kk",2],0,Ra),T("hmm",0,0,function(){return""+Qa.apply(this)+S(this.minutes(),2)}),T("hmmss",0,0,function(){return""+Qa.apply(this)+S(this.minutes(),2)+S(this.seconds(),2)}),T("Hmm",0,0,function(){return""+this.hours()+S(this.minutes(),2)}),T("Hmmss",0,0,function(){return""+this.hours()+S(this.minutes(),2)+S(this.seconds(),2)}),Sa("a",!0),Sa("A",!1),I("hour","h"),L("hour",13),Y("a",Ta),Y("A",Ta),Y("H",Kd),Y("h",Kd),Y("HH",Kd,Gd),Y("hh",Kd,Gd),Y("hmm",Ld),Y("hmmss",Md),Y("Hmm",Ld),Y("Hmmss",Md),aa(["H","HH"],_d),aa(["a","A"],function(a,b,c){c._isPm=c._locale.isPM(a),c._meridiem=a}),aa(["h","hh"],function(a,b,c){b[_d]=t(a),l(c).bigHour=!0}),aa("hmm",function(a,b,c){var d=a.length-2;b[_d]=t(a.substr(0,d)),b[ae]=t(a.substr(d)),l(c).bigHour=!0}),aa("hmmss",function(a,b,c){var d=a.length-4,e=a.length-2;b[_d]=t(a.substr(0,d)),b[ae]=t(a.substr(d,2)),b[be]=t(a.substr(e)),l(c).bigHour=!0}),aa("Hmm",function(a,b,c){var d=a.length-2;b[_d]=t(a.substr(0,d)),b[ae]=t(a.substr(d))}),aa("Hmmss",function(a,b,c){var d=a.length-4,e=a.length-2;b[_d]=t(a.substr(0,d)),b[ae]=t(a.substr(d,2)),b[be]=t(a.substr(e))});var se,te=/[ap]\.?m?\.?/i,ue=N("Hours",!0),ve={calendar:td,longDateFormat:ud,invalidDate:vd,ordinal:wd,ordinalParse:xd,relativeTime:yd,months:ge,monthsShort:he,week:le,weekdays:me,weekdaysMin:oe,weekdaysShort:ne,meridiemParse:te},we={},xe=/^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/,ye=/^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/,ze=/Z|[+-]\d\d(?::?\d\d)?/,Ae=[["YYYYYY-MM-DD",/[+-]\d{6}-\d\d-\d\d/],["YYYY-MM-DD",/\d{4}-\d\d-\d\d/],["GGGG-[W]WW-E",/\d{4}-W\d\d-\d/],["GGGG-[W]WW",/\d{4}-W\d\d/,!1],["YYYY-DDD",/\d{4}-\d{3}/],["YYYY-MM",/\d{4}-\d\d/,!1],["YYYYYYMMDD",/[+-]\d{10}/],["YYYYMMDD",/\d{8}/],["GGGG[W]WWE",/\d{4}W\d{3}/],["GGGG[W]WW",/\d{4}W\d{2}/,!1],["YYYYDDD",/\d{7}/]],Be=[["HH:mm:ss.SSSS",/\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss,SSSS",/\d\d:\d\d:\d\d,\d+/],["HH:mm:ss",/\d\d:\d\d:\d\d/],["HH:mm",/\d\d:\d\d/],["HHmmss.SSSS",/\d\d\d\d\d\d\.\d+/],["HHmmss,SSSS",/\d\d\d\d\d\d,\d+/],["HHmmss",/\d\d\d\d\d\d/],["HHmm",/\d\d\d\d/],["HH",/\d\d/]],Ce=/^\/?Date\((\-?\d+)/i;a.createFromInputFallback=w("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/js-date/ for more info.",function(a){a._d=new Date(a._i+(a._useUTC?" UTC":""))}),a.ISO_8601=function(){};var De=w("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var a=rb.apply(null,arguments);return this.isValid()&&a.isValid()?a<this?this:a:n()}),Ee=w("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var a=rb.apply(null,arguments);return this.isValid()&&a.isValid()?a>this?this:a:n()}),Fe=function(){return Date.now?Date.now():+new Date};xb("Z",":"),xb("ZZ",""),Y("Z",Td),Y("ZZ",Td),aa(["Z","ZZ"],function(a,b,c){c._useUTC=!0,c._tzm=yb(Td,a)});var Ge=/([\+\-]|\d\d)/gi;a.updateOffset=function(){};var He=/^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?\d*)?$/,Ie=/^(-)?P(?:(-?[0-9,.]*)Y)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)W)?(?:(-?[0-9,.]*)D)?(?:T(?:(-?[0-9,.]*)H)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)S)?)?$/;Mb.fn=vb.prototype;var Je=Rb(1,"add"),Ke=Rb(-1,"subtract");a.defaultFormat="YYYY-MM-DDTHH:mm:ssZ",a.defaultFormatUtc="YYYY-MM-DDTHH:mm:ss[Z]";var Le=w("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(a){return void 0===a?this.localeData():this.locale(a)});T(0,["gg",2],0,function(){return this.weekYear()%100}),T(0,["GG",2],0,function(){return this.isoWeekYear()%100}),xc("gggg","weekYear"),xc("ggggg","weekYear"),xc("GGGG","isoWeekYear"),xc("GGGGG","isoWeekYear"),I("weekYear","gg"),I("isoWeekYear","GG"),L("weekYear",1),L("isoWeekYear",1),Y("G",Rd),Y("g",Rd),Y("GG",Kd,Gd),Y("gg",Kd,Gd),Y("GGGG",Od,Id),Y("gggg",Od,Id),Y("GGGGG",Pd,Jd),Y("ggggg",Pd,Jd),ba(["gggg","ggggg","GGGG","GGGGG"],function(a,b,c,d){b[d.substr(0,2)]=t(a)}),ba(["gg","GG"],function(b,c,d,e){c[e]=a.parseTwoDigitYear(b)}),T("Q",0,"Qo","quarter"),I("quarter","Q"),L("quarter",7),Y("Q",Fd),aa("Q",function(a,b){b[Zd]=3*(t(a)-1)}),T("D",["DD",2],"Do","date"),I("date","D"),L("date",9),Y("D",Kd),Y("DD",Kd,Gd),Y("Do",function(a,b){return a?b._ordinalParse:b._ordinalParseLenient}),aa(["D","DD"],$d),aa("Do",function(a,b){b[$d]=t(a.match(Kd)[0],10)});var Me=N("Date",!0);T("DDD",["DDDD",3],"DDDo","dayOfYear"),I("dayOfYear","DDD"),L("dayOfYear",4),Y("DDD",Nd),Y("DDDD",Hd),aa(["DDD","DDDD"],function(a,b,c){c._dayOfYear=t(a)}),T("m",["mm",2],0,"minute"),I("minute","m"),L("minute",14),Y("m",Kd),Y("mm",Kd,Gd),aa(["m","mm"],ae);var Ne=N("Minutes",!1);T("s",["ss",2],0,"second"),I("second","s"),L("second",15),Y("s",Kd),Y("ss",Kd,Gd),aa(["s","ss"],be);var Oe=N("Seconds",!1);T("S",0,0,function(){return~~(this.millisecond()/100)}),T(0,["SS",2],0,function(){return~~(this.millisecond()/10)}),T(0,["SSS",3],0,"millisecond"),T(0,["SSSS",4],0,function(){return 10*this.millisecond()}),T(0,["SSSSS",5],0,function(){return 100*this.millisecond()}),T(0,["SSSSSS",6],0,function(){return 1e3*this.millisecond()}),T(0,["SSSSSSS",7],0,function(){return 1e4*this.millisecond()}),T(0,["SSSSSSSS",8],0,function(){return 1e5*this.millisecond()}),T(0,["SSSSSSSSS",9],0,function(){return 1e6*this.millisecond()}),I("millisecond","ms"),L("millisecond",16),Y("S",Nd,Fd),Y("SS",Nd,Gd),Y("SSS",Nd,Hd);var Pe;for(Pe="SSSS";Pe.length<=9;Pe+="S")Y(Pe,Qd);for(Pe="S";Pe.length<=9;Pe+="S")aa(Pe,Gc);var Qe=N("Milliseconds",!1);T("z",0,0,"zoneAbbr"),T("zz",0,0,"zoneName");var Re=q.prototype;Re.add=Je,Re.calendar=Ub,Re.clone=Vb,Re.diff=ac,Re.endOf=mc,Re.format=ec,Re.from=fc,Re.fromNow=gc,Re.to=hc,Re.toNow=ic,Re.get=Q,Re.invalidAt=vc,Re.isAfter=Wb,Re.isBefore=Xb,Re.isBetween=Yb,Re.isSame=Zb,Re.isSameOrAfter=$b,Re.isSameOrBefore=_b,Re.isValid=tc,Re.lang=Le,Re.locale=jc,Re.localeData=kc,Re.max=Ee,Re.min=De,Re.parsingFlags=uc,Re.set=R,Re.startOf=lc,Re.subtract=Ke,Re.toArray=qc,Re.toObject=rc,Re.toDate=pc,Re.toISOString=dc,Re.toJSON=sc,Re.toString=cc,Re.unix=oc,Re.valueOf=nc,Re.creationData=wc,Re.year=ke,Re.isLeapYear=qa,Re.weekYear=yc,Re.isoWeekYear=zc,Re.quarter=Re.quarters=Ec,Re.month=ja,Re.daysInMonth=ka,Re.week=Re.weeks=Aa,Re.isoWeek=Re.isoWeeks=Ba,Re.weeksInYear=Bc,Re.isoWeeksInYear=Ac,Re.date=Me,Re.day=Re.days=Ja,Re.weekday=Ka,Re.isoWeekday=La,Re.dayOfYear=Fc,Re.hour=Re.hours=ue,Re.minute=Re.minutes=Ne,Re.second=Re.seconds=Oe,Re.millisecond=Re.milliseconds=Qe,Re.utcOffset=Bb,Re.utc=Db,Re.local=Eb,Re.parseZone=Fb,Re.hasAlignedHourOffset=Gb,Re.isDST=Hb,Re.isLocal=Jb,Re.isUtcOffset=Kb,Re.isUtc=Lb,Re.isUTC=Lb,Re.zoneAbbr=Hc,Re.zoneName=Ic,Re.dates=w("dates accessor is deprecated. Use date instead.",Me),Re.months=w("months accessor is deprecated. Use month instead",ja),Re.years=w("years accessor is deprecated. Use year instead",ke),Re.zone=w("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/",Cb),Re.isDSTShifted=w("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information",Ib);var Se=Re,Te=B.prototype;Te.calendar=C,Te.longDateFormat=D,Te.invalidDate=E,Te.ordinal=F,Te.preparse=Lc,Te.postformat=Lc,Te.relativeTime=G,Te.pastFuture=H,Te.set=z,Te.months=ea,Te.monthsShort=fa,Te.monthsParse=ha,Te.monthsRegex=ma,Te.monthsShortRegex=la,Te.week=xa,Te.firstDayOfYear=za,Te.firstDayOfWeek=ya,Te.weekdays=Ea,Te.weekdaysMin=Ga,Te.weekdaysShort=Fa,Te.weekdaysParse=Ia,Te.weekdaysRegex=Ma,Te.weekdaysShortRegex=Na,Te.weekdaysMinRegex=Oa,Te.isPM=Ua,Te.meridiem=Va,Za("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(a){var b=a%10,c=1===t(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return a+c}}),a.lang=w("moment.lang is deprecated. Use moment.locale instead.",Za),a.langData=w("moment.langData is deprecated. Use moment.localeData instead.",ab);var Ue=Math.abs,Ve=cd("ms"),We=cd("s"),Xe=cd("m"),Ye=cd("h"),Ze=cd("d"),$e=cd("w"),_e=cd("M"),af=cd("y"),bf=ed("milliseconds"),cf=ed("seconds"),df=ed("minutes"),ef=ed("hours"),ff=ed("days"),gf=ed("months"),hf=ed("years"),jf=Math.round,kf={s:45,m:45,h:22,d:26,M:11},lf=Math.abs,mf=vb.prototype;mf.abs=Uc,mf.add=Wc,mf.subtract=Xc,mf.as=ad,mf.asMilliseconds=Ve,mf.asSeconds=We,mf.asMinutes=Xe,mf.asHours=Ye,mf.asDays=Ze,mf.asWeeks=$e,mf.asMonths=_e,mf.asYears=af,mf.valueOf=bd,mf._bubble=Zc,mf.get=dd,mf.milliseconds=bf,mf.seconds=cf,mf.minutes=df,mf.hours=ef,mf.days=ff,mf.weeks=fd,mf.months=gf,mf.years=hf,mf.humanize=kd,mf.toISOString=ld,mf.toString=ld,mf.toJSON=ld,mf.locale=jc,mf.localeData=kc,mf.toIsoString=w("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",ld),mf.lang=Le,T("X",0,0,"unix"),T("x",0,0,"valueOf"),Y("x",Rd),Y("X",Ud),aa("X",function(a,b,c){c._d=new Date(1e3*parseFloat(a,10))}),aa("x",function(a,b,c){c._d=new Date(t(a))}),a.version="2.14.1",b(rb),a.fn=Se,a.min=tb,a.max=ub,a.now=Fe,a.utc=j,a.unix=Jc,a.months=Pc,a.isDate=f,a.locale=Za,a.invalid=n,a.duration=Mb,a.isMoment=r,a.weekdays=Rc,a.parseZone=Kc,a.localeData=ab,a.isDuration=wb,a.monthsShort=Qc,a.weekdaysMin=Tc,a.defineLocale=$a,a.updateLocale=_a,a.locales=bb,a.weekdaysShort=Sc,a.normalizeUnits=J,a.relativeTimeRounding=id,a.relativeTimeThreshold=jd,a.calendarFormat=Tb,a.prototype=Se;var nf=a;return nf}),function(a,b){function c(a){var b="";if(a=parseInt(a,10),!a||a<1)return b;for(;a;)b+="0",a-=1;return b}function d(a,b,d){return null==a&&(a=""),a=""+a,(d?a:"")+c(b-a.length)+(d?"":a)}function e(a){return"[object Array]"===Object.prototype.toString.call(a)}function f(a){return"[object Object]"===Object.prototype.toString.call(a)}function g(a,b){for(var c=a.length;c-=1;)if(b(a[c]))return a[c]}function h(a,b){var c,d=0,e=a.length;for("function"!=typeof b&&(c=b,b=function(a){return a===c});d<e;){if(b(a[d]))return a[d];d+=1}}function i(a,b){var c=0,d=a.length;if(a&&d)for(;c<d;){if(b(a[c],c)===!1)return;c+=1}}function j(a,b){var c=0,d=a.length,e=[];if(!a||!d)return e;for(;c<d;)e[c]=b(a[c],c),c+=1;return e}function k(a,b){return j(a,function(a){return a[b]})}function l(a){var b=[];return i(a,function(a){a&&b.push(a)}),b}function m(a){var b=[];return i(a,function(a){h(b,a)||b.push(a)}),b}function n(a,b){var c=[];return i(a,function(a){i(b,function(b){a===b&&c.push(a)})}),m(c)}function o(a,b){var c=[];return i(a,function(d,e){if(!b(d))return c=a.slice(e),!1}),c}function p(a,b){var c=a.slice().reverse();return o(c,b).reverse()}function q(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);return a}var r;if("function"==typeof require)try{r=require("moment")}catch(a){}if(!r&&a.moment&&(r=a.moment),!r)throw"Moment Duration Format cannot find Moment.js";r.duration.fn.format=function(){var a,b,g,s,t,u,v=[].slice.call(arguments),w=q({},this.format.defaults),x=r.duration(this);return w.duration=this,i(v,function(a){return"string"==typeof a||"function"==typeof a?void(w.template=a):"number"==typeof a?void(w.precision=a):void(f(a)&&q(w,a))}),g=w.types=e(w.types)?w.types:w.types.split(" "),"function"==typeof w.template&&(w.template=w.template.apply(w)),a=new RegExp(j(g,function(a){return w[a].source}).join("|"),"g"),s=function(a){return h(g,function(b){return w[b].test(a)})},b=j(w.template.match(a),function(a,b){var c=s(a),d=a.length;return{index:b,length:d,token:"escape"===c?a.replace(w.escape,"$1"):a,type:"escape"===c||"general"===c?null:c}},this),t=n(g,m(l(k(b,"type")))),t.length?(i(t,function(a,c){var d,e,f,g,h;d=x.as(a),e=d>0?Math.floor(d):Math.ceil(d),f=d-e,g=c+1===t.length,h=!c,i(b,function(b){b.type===a&&(q(b,{value:d,wholeValue:e,decimalValue:f,isLeast:g,isMost:h}),h&&null==w.forceLength&&b.length>1&&(w.forceLength=!0))}),x.subtract(e,a)}),w.trim&&(b=("left"===w.trim?o:p)(b,function(a){return!(a.isLeast||null!=a.type&&a.wholeValue)})),u=!1,"right"===w.trim&&b.reverse(),b=j(b,function(a){var b,e;if(!a.type)return a.token;if(b=a.isLeast&&w.precision<0?(Math.floor(a.wholeValue*Math.pow(10,w.precision))*Math.pow(10,-w.precision)).toString():a.wholeValue.toString(),b=b.replace(/^\-/,""),a.length>1&&(u||a.isMost||w.forceLength)&&(b=d(b,a.length)),a.isLeast&&w.precision>0)switch(e=a.decimalValue.toString().replace(/^\-/,"").split(/\.|e\-/),e.length){case 1:b+="."+d(e[0],w.precision,!0).slice(0,w.precision);break;case 2:b+="."+d(e[1],w.precision,!0).slice(0,w.precision);break;case 3:b+="."+d(c(+e[2]-1)+(e[0]||"0")+e[1],w.precision,!0).slice(0,w.precision);break;default:throw"Moment Duration Format: unable to parse token decimal value."}return a.isMost&&a.value<0&&(b="-"+b),u=!0,b}),"right"===w.trim&&b.reverse(),b.join("")):k(b,"token").join("")},r.duration.fn.format.defaults={escape:/\[(.+?)\]/,years:/[Yy]+/,months:/M+/,weeks:/[Ww]+/,days:/[Dd]+/,hours:/[Hh]+/,minutes:/m+/,seconds:/s+/,milliseconds:/S+/,general:/.+?/,types:"escape years months weeks days hours minutes seconds milliseconds general",trim:"left",precision:0,forceLength:null,template:function(){var a=this.types,b=this.duration,c=g(a,function(a){return b._data[a]});switch(c){case"seconds":return"h:mm:ss";case"minutes":return"d[d] h:mm";case"hours":return"d[d] h[h]";case"days":return"M[m] d[d]";case"weeks":return"y[y] w[w]";case"months":return"y[y] M[m]";case"years":return"y[y]";default:return"y[y] M[m] d[d] h:mm:ss"}}}}(this),function(a,b){"function"==typeof define&&define.amd?define(b):"object"==typeof exports?module.exports=b():a.NProgress=b()}(this,function(){function a(a,b,c){return a<b?b:a>c?c:a}function b(a){return 100*(-1+a)}function c(a,c,d){var e;return e="translate3d"===j.positionUsing?{transform:"translate3d("+b(a)+"%,0,0)"}:"translate"===j.positionUsing?{transform:"translate("+b(a)+"%,0)"}:{"margin-left":b(a)+"%"},e.transition="all "+c+"ms "+d,e}function d(a,b){var c="string"==typeof a?a:g(a);return c.indexOf(" "+b+" ")>=0}function e(a,b){var c=g(a),e=c+b;d(c,b)||(a.className=e.substring(1))}function f(a,b){var c,e=g(a);d(a,b)&&(c=e.replace(" "+b+" "," "),a.className=c.substring(1,c.length-1))}function g(a){return(" "+(a.className||"")+" ").replace(/\s+/gi," ")}function h(a){a&&a.parentNode&&a.parentNode.removeChild(a)}var i={};i.version="0.2.0";var j=i.settings={minimum:.08,easing:"ease",positionUsing:"",speed:200,trickle:!0,trickleRate:.02,trickleSpeed:800,showSpinner:!0,barSelector:'[role="bar"]',spinnerSelector:'[role="spinner"]',parent:"body",template:'<div class="bar" role="bar"><div class="peg"></div></div><div class="spinner" role="spinner"><div class="spinner-icon"></div></div>'};i.configure=function(a){var b,c;for(b in a)c=a[b],void 0!==c&&a.hasOwnProperty(b)&&(j[b]=c);return this},i.status=null,i.set=function(b){var d=i.isStarted();b=a(b,j.minimum,1),i.status=1===b?null:b;var e=i.render(!d),f=e.querySelector(j.barSelector),g=j.speed,h=j.easing;return e.offsetWidth,k(function(a){""===j.positionUsing&&(j.positionUsing=i.getPositioningCSS()),l(f,c(b,g,h)),1===b?(l(e,{transition:"none",opacity:1}),e.offsetWidth,setTimeout(function(){l(e,{transition:"all "+g+"ms linear",opacity:0}),setTimeout(function(){i.remove(),a()},g)},g)):setTimeout(a,g)}),this},i.isStarted=function(){return"number"==typeof i.status},i.start=function(){i.status||i.set(0);var a=function(){setTimeout(function(){i.status&&(i.trickle(),a())},j.trickleSpeed)};return j.trickle&&a(),this},i.done=function(a){return a||i.status?i.inc(.3+.5*Math.random()).set(1):this},i.inc=function(b){var c=i.status;return c?("number"!=typeof b&&(b=(1-c)*a(Math.random()*c,.1,.95)),c=a(c+b,0,.994),i.set(c)):i.start()},i.trickle=function(){return i.inc(Math.random()*j.trickleRate)},function(){var a=0,b=0;i.promise=function(c){return c&&"resolved"!==c.state()?(0===b&&i.start(),a++,b++,c.always(function(){b--,0===b?(a=0,i.done()):i.set((a-b)/a)}),this):this}}(),i.render=function(a){if(i.isRendered())return document.getElementById("nprogress");e(document.documentElement,"nprogress-busy");var c=document.createElement("div");c.id="nprogress",c.innerHTML=j.template;var d,f=c.querySelector(j.barSelector),g=a?"-100":b(i.status||0),k=document.querySelector(j.parent);return l(f,{transition:"all 0 linear",transform:"translate3d("+g+"%,0,0)"}),j.showSpinner||(d=c.querySelector(j.spinnerSelector),d&&h(d)),k!=document.body&&e(k,"nprogress-custom-parent"),k.appendChild(c),c},i.remove=function(){f(document.documentElement,"nprogress-busy"),f(document.querySelector(j.parent),"nprogress-custom-parent");var a=document.getElementById("nprogress");a&&h(a)},i.isRendered=function(){return!!document.getElementById("nprogress")},i.getPositioningCSS=function(){var a=document.body.style,b="WebkitTransform"in a?"Webkit":"MozTransform"in a?"Moz":"msTransform"in a?"ms":"OTransform"in a?"O":"";return b+"Perspective"in a?"translate3d":b+"Transform"in a?"translate":"margin"};var k=function(){function a(){var c=b.shift();c&&c(a)}var b=[];return function(c){b.push(c),1==b.length&&a()}}(),l=function(){function a(a){return a.replace(/^-ms-/,"ms-").replace(/-([\da-z])/gi,function(a,b){return b.toUpperCase()})}function b(a){var b=document.body.style;if(a in b)return a;for(var c,d=e.length,f=a.charAt(0).toUpperCase()+a.slice(1);d--;)if(c=e[d]+f,c in b)return c;return a}function c(c){return c=a(c),f[c]||(f[c]=b(c))}function d(a,b,d){b=c(b),a.style[b]=d}var e=["Webkit","O","Moz","ms"],f={};return function(a,b){var c,e,f=arguments;if(2==f.length)for(c in b)e=b[c],void 0!==e&&b.hasOwnProperty(c)&&d(a,c,e);else d(a,f[1],f[2])}}();return i}),function(a,b){"function"==typeof define&&define.amd?define([],b):"object"==typeof exports?module.exports=b():a.Autolinker=b()}(this,function(){var a=function(b){b=b||{},this.version=a.version,this.urls=this.normalizeUrlsCfg(b.urls),this.email="boolean"!=typeof b.email||b.email,this.twitter="boolean"!=typeof b.twitter||b.twitter,this.phone="boolean"!=typeof b.phone||b.phone,this.hashtag=b.hashtag||!1,this.newWindow="boolean"!=typeof b.newWindow||b.newWindow,this.stripPrefix="boolean"!=typeof b.stripPrefix||b.stripPrefix;var c=this.hashtag;if(c!==!1&&"twitter"!==c&&"facebook"!==c&&"instagram"!==c)throw new Error("invalid `hashtag` cfg - see docs");this.truncate=this.normalizeTruncateCfg(b.truncate),this.className=b.className||"",this.replaceFn=b.replaceFn||null,this.htmlParser=null,this.matchers=null,this.tagBuilder=null};return a.link=function(b,c){var d=new a(c);return d.link(b)},a.version="0.27.0",a.prototype={constructor:a,normalizeUrlsCfg:function(a){return null==a&&(a=!0),"boolean"==typeof a?{schemeMatches:a,wwwMatches:a,tldMatches:a}:{schemeMatches:"boolean"!=typeof a.schemeMatches||a.schemeMatches,wwwMatches:"boolean"!=typeof a.wwwMatches||a.wwwMatches,tldMatches:"boolean"!=typeof a.tldMatches||a.tldMatches}},normalizeTruncateCfg:function(b){return"number"==typeof b?{length:b,location:"end"}:a.Util.defaults(b||{},{length:Number.POSITIVE_INFINITY,location:"end"})},parse:function(a){for(var b=this.getHtmlParser(),c=b.parse(a),d=0,e=[],f=0,g=c.length;f<g;f++){var h=c[f],i=h.getType();if("element"===i&&"a"===h.getTagName())h.isClosing()?d=Math.max(d-1,0):d++;else if("text"===i&&0===d){var j=this.parseText(h.getText(),h.getOffset());e.push.apply(e,j)}}return e=this.compactMatches(e),e=this.removeUnwantedMatches(e)},compactMatches:function(a){a.sort(function(a,b){return a.getOffset()-b.getOffset()});for(var b=0;b<a.length-1;b++)for(var c=a[b],d=c.getOffset()+c.getMatchedText().length;b+1<a.length&&a[b+1].getOffset()<=d;)a.splice(b+1,1);return a},removeUnwantedMatches:function(b){var c=a.Util.remove;return this.hashtag||c(b,function(a){return"hashtag"===a.getType()}),this.email||c(b,function(a){return"email"===a.getType()}),this.phone||c(b,function(a){return"phone"===a.getType()}),this.twitter||c(b,function(a){return"twitter"===a.getType()}),this.urls.schemeMatches||c(b,function(a){return"url"===a.getType()&&"scheme"===a.getUrlMatchType()}),this.urls.wwwMatches||c(b,function(a){return"url"===a.getType()&&"www"===a.getUrlMatchType()}),this.urls.tldMatches||c(b,function(a){return"url"===a.getType()&&"tld"===a.getUrlMatchType()}),b},parseText:function(a,b){b=b||0;for(var c=this.getMatchers(),d=[],e=0,f=c.length;e<f;e++){for(var g=c[e].parseMatches(a),h=0,i=g.length;h<i;h++)g[h].setOffset(b+g[h].getOffset());d.push.apply(d,g)}return d},link:function(a){if(!a)return"";for(var b=this.parse(a),c=[],d=0,e=0,f=b.length;e<f;e++){var g=b[e];c.push(a.substring(d,g.getOffset())),c.push(this.createMatchReturnVal(g)),d=g.getOffset()+g.getMatchedText().length}return c.push(a.substring(d)),c.join("")},createMatchReturnVal:function(b){var c;if(this.replaceFn&&(c=this.replaceFn.call(this,this,b)),"string"==typeof c)return c;if(c===!1)return b.getMatchedText();if(c instanceof a.HtmlTag)return c.toAnchorString();var d=b.buildTag();return d.toAnchorString()},getHtmlParser:function(){var b=this.htmlParser;return b||(b=this.htmlParser=new a.htmlParser.HtmlParser),b},getMatchers:function(){if(this.matchers)return this.matchers;var b=a.matcher,c=this.getTagBuilder(),d=[new b.Hashtag({tagBuilder:c,serviceName:this.hashtag}),new b.Email({tagBuilder:c}),new b.Phone({tagBuilder:c}),new b.Twitter({tagBuilder:c}),new b.Url({tagBuilder:c,stripPrefix:this.stripPrefix})];return this.matchers=d},getTagBuilder:function(){var b=this.tagBuilder;return b||(b=this.tagBuilder=new a.AnchorTagBuilder({newWindow:this.newWindow,truncate:this.truncate,className:this.className})),b}},a.match={},a.matcher={},a.htmlParser={},a.truncate={},a.Util={abstractMethod:function(){throw"abstract"},trimRegex:/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,assign:function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);return a},defaults:function(a,b){for(var c in b)b.hasOwnProperty(c)&&void 0===a[c]&&(a[c]=b[c]);return a},extend:function(b,c){var d=b.prototype,e=function(){};e.prototype=d;var f;f=c.hasOwnProperty("constructor")?c.constructor:function(){d.constructor.apply(this,arguments)};var g=f.prototype=new e;return g.constructor=f,g.superclass=d,delete c.constructor,a.Util.assign(g,c),f},ellipsis:function(a,b,c){return a.length>b&&(c=null==c?"..":c,a=a.substring(0,b-c.length)+c),a},indexOf:function(a,b){if(Array.prototype.indexOf)return a.indexOf(b);for(var c=0,d=a.length;c<d;c++)if(a[c]===b)return c;return-1},remove:function(a,b){for(var c=a.length-1;c>=0;c--)b(a[c])===!0&&a.splice(c,1)},splitAndCapture:function(a,b){if(!b.global)throw new Error("`splitRegex` must have the 'g' flag set");for(var c,d=[],e=0;c=b.exec(a);)d.push(a.substring(e,c.index)),d.push(c[0]),e=c.index+c[0].length;return d.push(a.substring(e)),d},trim:function(a){return a.replace(this.trimRegex,"")}},a.HtmlTag=a.Util.extend(Object,{whitespaceRegex:/\s+/,constructor:function(b){a.Util.assign(this,b),this.innerHtml=this.innerHtml||this.innerHTML},setTagName:function(a){return this.tagName=a,this},getTagName:function(){return this.tagName||""},setAttr:function(a,b){var c=this.getAttrs();return c[a]=b,this},getAttr:function(a){return this.getAttrs()[a]},setAttrs:function(b){var c=this.getAttrs();return a.Util.assign(c,b),this},getAttrs:function(){return this.attrs||(this.attrs={})},setClass:function(a){return this.setAttr("class",a)},addClass:function(b){for(var c,d=this.getClass(),e=this.whitespaceRegex,f=a.Util.indexOf,g=d?d.split(e):[],h=b.split(e);c=h.shift();)f(g,c)===-1&&g.push(c);return this.getAttrs().class=g.join(" "),this},removeClass:function(b){for(var c,d=this.getClass(),e=this.whitespaceRegex,f=a.Util.indexOf,g=d?d.split(e):[],h=b.split(e);g.length&&(c=h.shift());){var i=f(g,c);i!==-1&&g.splice(i,1)}return this.getAttrs().class=g.join(" "),this},getClass:function(){return this.getAttrs().class||""},hasClass:function(a){return(" "+this.getClass()+" ").indexOf(" "+a+" ")!==-1},setInnerHtml:function(a){return this.innerHtml=a,this},getInnerHtml:function(){return this.innerHtml||""},toAnchorString:function(){var a=this.getTagName(),b=this.buildAttrsStr();return b=b?" "+b:"",["<",a,b,">",this.getInnerHtml(),"</",a,">"].join("")},buildAttrsStr:function(){if(!this.attrs)return"";var a=this.getAttrs(),b=[];for(var c in a)a.hasOwnProperty(c)&&b.push(c+'="'+a[c]+'"');return b.join(" ")}}),a.RegexLib=function(){var a="A-Za-z\\xAA\\xB5\\xBA\\xC0-\\xD6\\xD8-\\xF6\\xF8-\u02c1\u02c6-\u02d1\u02e0-\u02e4\u02ec\u02ee\u0370-\u0374\u0376\u0377\u037a-\u037d\u037f\u0386\u0388-\u038a\u038c\u038e-\u03a1\u03a3-\u03f5\u03f7-\u0481\u048a-\u052f\u0531-\u0556\u0559\u0561-\u0587\u05d0-\u05ea\u05f0-\u05f2\u0620-\u064a\u066e\u066f\u0671-\u06d3\u06d5\u06e5\u06e6\u06ee\u06ef\u06fa-\u06fc\u06ff\u0710\u0712-\u072f\u074d-\u07a5\u07b1\u07ca-\u07ea\u07f4\u07f5\u07fa\u0800-\u0815\u081a\u0824\u0828\u0840-\u0858\u08a0-\u08b4\u0904-\u0939\u093d\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098c\u098f\u0990\u0993-\u09a8\u09aa-\u09b0\u09b2\u09b6-\u09b9\u09bd\u09ce\u09dc\u09dd\u09df-\u09e1\u09f0\u09f1\u0a05-\u0a0a\u0a0f\u0a10\u0a13-\u0a28\u0a2a-\u0a30\u0a32\u0a33\u0a35\u0a36\u0a38\u0a39\u0a59-\u0a5c\u0a5e\u0a72-\u0a74\u0a85-\u0a8d\u0a8f-\u0a91\u0a93-\u0aa8\u0aaa-\u0ab0\u0ab2\u0ab3\u0ab5-\u0ab9\u0abd\u0ad0\u0ae0\u0ae1\u0af9\u0b05-\u0b0c\u0b0f\u0b10\u0b13-\u0b28\u0b2a-\u0b30\u0b32\u0b33\u0b35-\u0b39\u0b3d\u0b5c\u0b5d\u0b5f-\u0b61\u0b71\u0b83\u0b85-\u0b8a\u0b8e-\u0b90\u0b92-\u0b95\u0b99\u0b9a\u0b9c\u0b9e\u0b9f\u0ba3\u0ba4\u0ba8-\u0baa\u0bae-\u0bb9\u0bd0\u0c05-\u0c0c\u0c0e-\u0c10\u0c12-\u0c28\u0c2a-\u0c39\u0c3d\u0c58-\u0c5a\u0c60\u0c61\u0c85-\u0c8c\u0c8e-\u0c90\u0c92-\u0ca8\u0caa-\u0cb3\u0cb5-\u0cb9\u0cbd\u0cde\u0ce0\u0ce1\u0cf1\u0cf2\u0d05-\u0d0c\u0d0e-\u0d10\u0d12-\u0d3a\u0d3d\u0d4e\u0d5f-\u0d61\u0d7a-\u0d7f\u0d85-\u0d96\u0d9a-\u0db1\u0db3-\u0dbb\u0dbd\u0dc0-\u0dc6\u0e01-\u0e30\u0e32\u0e33\u0e40-\u0e46\u0e81\u0e82\u0e84\u0e87\u0e88\u0e8a\u0e8d\u0e94-\u0e97\u0e99-\u0e9f\u0ea1-\u0ea3\u0ea5\u0ea7\u0eaa\u0eab\u0ead-\u0eb0\u0eb2\u0eb3\u0ebd\u0ec0-\u0ec4\u0ec6\u0edc-\u0edf\u0f00\u0f40-\u0f47\u0f49-\u0f6c\u0f88-\u0f8c\u1000-\u102a\u103f\u1050-\u1055\u105a-\u105d\u1061\u1065\u1066\u106e-\u1070\u1075-\u1081\u108e\u10a0-\u10c5\u10c7\u10cd\u10d0-\u10fa\u10fc-\u1248\u124a-\u124d\u1250-\u1256\u1258\u125a-\u125d\u1260-\u1288\u128a-\u128d\u1290-\u12b0\u12b2-\u12b5\u12b8-\u12be\u12c0\u12c2-\u12c5\u12c8-\u12d6\u12d8-\u1310\u1312-\u1315\u1318-\u135a\u1380-\u138f\u13a0-\u13f5\u13f8-\u13fd\u1401-\u166c\u166f-\u167f\u1681-\u169a\u16a0-\u16ea\u16f1-\u16f8\u1700-\u170c\u170e-\u1711\u1720-\u1731\u1740-\u1751\u1760-\u176c\u176e-\u1770\u1780-\u17b3\u17d7\u17dc\u1820-\u1877\u1880-\u18a8\u18aa\u18b0-\u18f5\u1900-\u191e\u1950-\u196d\u1970-\u1974\u1980-\u19ab\u19b0-\u19c9\u1a00-\u1a16\u1a20-\u1a54\u1aa7\u1b05-\u1b33\u1b45-\u1b4b\u1b83-\u1ba0\u1bae\u1baf\u1bba-\u1be5\u1c00-\u1c23\u1c4d-\u1c4f\u1c5a-\u1c7d\u1ce9-\u1cec\u1cee-\u1cf1\u1cf5\u1cf6\u1d00-\u1dbf\u1e00-\u1f15\u1f18-\u1f1d\u1f20-\u1f45\u1f48-\u1f4d\u1f50-\u1f57\u1f59\u1f5b\u1f5d\u1f5f-\u1f7d\u1f80-\u1fb4\u1fb6-\u1fbc\u1fbe\u1fc2-\u1fc4\u1fc6-\u1fcc\u1fd0-\u1fd3\u1fd6-\u1fdb\u1fe0-\u1fec\u1ff2-\u1ff4\u1ff6-\u1ffc\u2071\u207f\u2090-\u209c\u2102\u2107\u210a-\u2113\u2115\u2119-\u211d\u2124\u2126\u2128\u212a-\u212d\u212f-\u2139\u213c-\u213f\u2145-\u2149\u214e\u2183\u2184\u2c00-\u2c2e\u2c30-\u2c5e\u2c60-\u2ce4\u2ceb-\u2cee\u2cf2\u2cf3\u2d00-\u2d25\u2d27\u2d2d\u2d30-\u2d67\u2d6f\u2d80-\u2d96\u2da0-\u2da6\u2da8-\u2dae\u2db0-\u2db6\u2db8-\u2dbe\u2dc0-\u2dc6\u2dc8-\u2dce\u2dd0-\u2dd6\u2dd8-\u2dde\u2e2f\u3005\u3006\u3031-\u3035\u303b\u303c\u3041-\u3096\u309d-\u309f\u30a1-\u30fa\u30fc-\u30ff\u3105-\u312d\u3131-\u318e\u31a0-\u31ba\u31f0-\u31ff\u3400-\u4db5\u4e00-\u9fd5\ua000-\ua48c\ua4d0-\ua4fd\ua500-\ua60c\ua610-\ua61f\ua62a\ua62b\ua640-\ua66e\ua67f-\ua69d\ua6a0-\ua6e5\ua717-\ua71f\ua722-\ua788\ua78b-\ua7ad\ua7b0-\ua7b7\ua7f7-\ua801\ua803-\ua805\ua807-\ua80a\ua80c-\ua822\ua840-\ua873\ua882-\ua8b3\ua8f2-\ua8f7\ua8fb\ua8fd\ua90a-\ua925\ua930-\ua946\ua960-\ua97c\ua984-\ua9b2\ua9cf\ua9e0-\ua9e4\ua9e6-\ua9ef\ua9fa-\ua9fe\uaa00-\uaa28\uaa40-\uaa42\uaa44-\uaa4b\uaa60-\uaa76\uaa7a\uaa7e-\uaaaf\uaab1\uaab5\uaab6\uaab9-\uaabd\uaac0\uaac2\uaadb-\uaadd\uaae0-\uaaea\uaaf2-\uaaf4\uab01-\uab06\uab09-\uab0e\uab11-\uab16\uab20-\uab26\uab28-\uab2e\uab30-\uab5a\uab5c-\uab65\uab70-\uabe2\uac00-\ud7a3\ud7b0-\ud7c6\ud7cb-\ud7fb\uf900-\ufa6d\ufa70-\ufad9\ufb00-\ufb06\ufb13-\ufb17\ufb1d\ufb1f-\ufb28\ufb2a-\ufb36\ufb38-\ufb3c\ufb3e\ufb40\ufb41\ufb43\ufb44\ufb46-\ufbb1\ufbd3-\ufd3d\ufd50-\ufd8f\ufd92-\ufdc7\ufdf0-\ufdfb\ufe70-\ufe74\ufe76-\ufefc\uff21-\uff3a\uff41-\uff5a\uff66-\uffbe\uffc2-\uffc7\uffca-\uffcf\uffd2-\uffd7\uffda-\uffdc",b="0-9\u0660-\u0669\u06f0-\u06f9\u07c0-\u07c9\u0966-\u096f\u09e6-\u09ef\u0a66-\u0a6f\u0ae6-\u0aef\u0b66-\u0b6f\u0be6-\u0bef\u0c66-\u0c6f\u0ce6-\u0cef\u0d66-\u0d6f\u0de6-\u0def\u0e50-\u0e59\u0ed0-\u0ed9\u0f20-\u0f29\u1040-\u1049\u1090-\u1099\u17e0-\u17e9\u1810-\u1819\u1946-\u194f\u19d0-\u19d9\u1a80-\u1a89\u1a90-\u1a99\u1b50-\u1b59\u1bb0-\u1bb9\u1c40-\u1c49\u1c50-\u1c59\ua620-\ua629\ua8d0-\ua8d9\ua900-\ua909\ua9d0-\ua9d9\ua9f0-\ua9f9\uaa50-\uaa59\uabf0-\uabf9\uff10-\uff19",c=a+b,d=new RegExp("["+c+".\\-]*["+c+"\\-]"),e=/(?:travelersinsurance|sandvikcoromant|kerryproperties|cancerresearch|weatherchannel|kerrylogistics|spreadbetting|international|wolterskluwer|lifeinsurance|construction|pamperedchef|scholarships|versicherung|bridgestone|creditunion|kerryhotels|investments|productions|blackfriday|enterprises|lamborghini|photography|motorcycles|williamhill|playstation|contractors|barclaycard|accountants|redumbrella|engineering|management|telefonica|protection|consulting|tatamotors|creditcard|vlaanderen|schaeffler|associates|properties|foundation|republican|bnpparibas|boehringer|eurovision|extraspace|industries|immobilien|university|technology|volkswagen|healthcare|restaurant|cuisinella|vistaprint|apartments|accountant|travelers|homedepot|institute|vacations|furniture|fresenius|insurance|christmas|bloomberg|solutions|barcelona|firestone|financial|kuokgroup|fairwinds|community|passagens|goldpoint|equipment|lifestyle|yodobashi|aquarelle|marketing|analytics|education|amsterdam|statefarm|melbourne|allfinanz|directory|microsoft|stockholm|montblanc|accenture|lancaster|landrover|everbank|istanbul|graphics|grainger|ipiranga|softbank|attorney|pharmacy|saarland|catering|airforce|yokohama|mortgage|frontier|mutuelle|stcgroup|memorial|pictures|football|symantec|cipriani|ventures|telecity|cityeats|verisign|flsmidth|boutique|cleaning|firmdale|clinique|clothing|redstone|infiniti|deloitte|feedback|services|broadway|plumbing|commbank|training|barclays|exchange|computer|brussels|software|delivery|barefoot|builders|business|bargains|engineer|holdings|download|security|helsinki|lighting|movistar|discount|hdfcbank|supplies|marriott|property|diamonds|capetown|partners|democrat|jpmorgan|bradesco|budapest|rexroth|zuerich|shriram|academy|science|support|youtube|singles|surgery|alibaba|statoil|dentist|schwarz|android|cruises|cricket|digital|markets|starhub|systems|courses|coupons|netbank|country|domains|corsica|network|neustar|realtor|lincoln|limited|schmidt|yamaxun|cooking|contact|auction|spiegel|liaison|leclerc|latrobe|lasalle|abogado|compare|lanxess|exposed|express|company|cologne|college|avianca|lacaixa|fashion|recipes|ferrero|komatsu|storage|wanggou|clubmed|sandvik|fishing|fitness|bauhaus|kitchen|flights|florist|flowers|watches|weather|temasek|samsung|bentley|forsale|channel|theater|frogans|theatre|okinawa|website|tickets|jewelry|gallery|tiffany|iselect|shiksha|brother|organic|wedding|genting|toshiba|origins|philips|hyundai|hotmail|hoteles|hosting|rentals|windows|cartier|bugatti|holiday|careers|whoswho|hitachi|panerai|caravan|reviews|guitars|capital|trading|hamburg|hangout|finance|stream|family|abbott|health|review|travel|report|hermes|hiphop|gratis|career|toyota|hockey|dating|repair|google|social|soccer|reisen|global|otsuka|giving|unicom|casino|photos|center|broker|rocher|orange|bostik|garden|insure|ryukyu|bharti|safety|physio|sakura|oracle|online|jaguar|gallup|piaget|tienda|futbol|pictet|joburg|webcam|berlin|office|juegos|kaufen|chanel|chrome|xihuan|church|tennis|circle|kinder|flickr|bayern|claims|clinic|viajes|nowruz|xperia|norton|yachts|studio|coffee|camera|sanofi|nissan|author|expert|events|comsec|lawyer|tattoo|viking|estate|villas|condos|realty|yandex|energy|emerck|virgin|vision|durban|living|school|coupon|london|taobao|natura|taipei|nagoya|luxury|walter|aramco|sydney|madrid|credit|maison|makeup|schule|market|anquan|direct|design|swatch|suzuki|alsace|vuelos|dental|alipay|voyage|shouji|voting|airtel|mutual|degree|supply|agency|museum|mobily|dealer|monash|select|mormon|active|moscow|racing|datsun|quebec|nissay|rodeo|email|gifts|works|photo|chloe|edeka|cheap|earth|vista|tushu|koeln|glass|shoes|globo|tunes|gmail|nokia|space|kyoto|black|ricoh|seven|lamer|sener|epson|cisco|praxi|trust|citic|crown|shell|lease|green|legal|lexus|ninja|tatar|gripe|nikon|group|video|wales|autos|gucci|party|nexus|guide|linde|adult|parts|amica|lixil|boats|azure|loans|locus|cymru|lotte|lotto|stada|click|poker|quest|dabur|lupin|nadex|paris|faith|dance|canon|place|gives|trade|skype|rocks|mango|cloud|boots|smile|final|swiss|homes|honda|media|horse|cards|deals|watch|bosch|house|pizza|miami|osaka|tours|total|xerox|coach|sucks|style|delta|toray|iinet|tools|money|codes|beats|tokyo|salon|archi|movie|baidu|study|actor|yahoo|store|apple|world|forex|today|bible|tmall|tirol|irish|tires|forum|reise|vegas|vodka|sharp|omega|weber|jetzt|audio|promo|build|bingo|chase|gallo|drive|dubai|rehab|press|solar|sale|beer|bbva|bank|band|auto|sapo|sarl|saxo|audi|asia|arte|arpa|army|yoga|ally|zara|scor|scot|sexy|seat|zero|seek|aero|adac|zone|aarp|maif|meet|meme|menu|surf|mini|mobi|mtpc|porn|desi|star|ltda|name|talk|navy|love|loan|live|link|news|limo|like|spot|life|nico|lidl|lgbt|land|taxi|team|tech|kred|kpmg|sony|song|kiwi|kddi|jprs|jobs|sohu|java|itau|tips|info|immo|icbc|hsbc|town|host|page|toys|here|help|pars|haus|guru|guge|tube|goog|golf|gold|sncf|gmbh|gift|ggee|gent|gbiz|game|vana|pics|fund|ford|ping|pink|fish|film|fast|farm|play|fans|fail|plus|skin|pohl|fage|moda|post|erni|dvag|prod|doha|prof|docs|viva|diet|luxe|site|dell|sina|dclk|show|qpon|date|vote|cyou|voto|read|coop|cool|wang|club|city|chat|cern|cash|reit|rent|casa|cars|care|camp|rest|call|cafe|weir|wien|rich|wiki|buzz|wine|book|bond|room|work|rsvp|shia|ruhr|blue|bing|shaw|bike|safe|xbox|best|pwc|mtn|lds|aig|boo|fyi|nra|nrw|ntt|car|gal|obi|zip|aeg|vin|how|one|ong|onl|dad|ooo|bet|esq|org|htc|bar|uol|ibm|ovh|gdn|ice|icu|uno|gea|ifm|bot|top|wtf|lol|day|pet|eus|wtc|ubs|tvs|aco|ing|ltd|ink|tab|abb|afl|cat|int|pid|pin|bid|cba|gle|com|cbn|ads|man|wed|ceb|gmo|sky|ist|gmx|tui|mba|fan|ski|iwc|app|pro|med|ceo|jcb|jcp|goo|dev|men|aaa|meo|pub|jlc|bom|jll|gop|jmp|mil|got|gov|win|jot|mma|joy|trv|red|cfa|cfd|bio|moe|moi|mom|ren|biz|aws|xin|bbc|dnp|buy|kfh|mov|thd|xyz|fit|kia|rio|rip|kim|dog|vet|nyc|bcg|mtr|bcn|bms|bmw|run|bzh|rwe|tel|stc|axa|kpn|fly|krd|cab|bnl|foo|crs|eat|tci|sap|srl|nec|sas|net|cal|sbs|sfr|sca|scb|csc|edu|new|xxx|hiv|fox|wme|ngo|nhk|vip|sex|frl|lat|yun|law|you|tax|soy|sew|om|ac|hu|se|sc|sg|sh|sb|sa|rw|ru|rs|ro|re|qa|py|si|pw|pt|ps|sj|sk|pr|pn|pm|pl|sl|sm|pk|sn|ph|so|pg|pf|pe|pa|zw|nz|nu|nr|np|no|nl|ni|ng|nf|sr|ne|st|nc|na|mz|my|mx|mw|mv|mu|mt|ms|mr|mq|mp|mo|su|mn|mm|ml|mk|mh|mg|me|sv|md|mc|sx|sy|ma|ly|lv|sz|lu|lt|ls|lr|lk|li|lc|lb|la|tc|kz|td|ky|kw|kr|kp|kn|km|ki|kh|tf|tg|th|kg|ke|jp|jo|jm|je|it|is|ir|tj|tk|tl|tm|iq|tn|to|io|in|im|il|ie|ad|sd|ht|hr|hn|hm|tr|hk|gy|gw|gu|gt|gs|gr|gq|tt|gp|gn|gm|gl|tv|gi|tw|tz|ua|gh|ug|uk|gg|gf|ge|gd|us|uy|uz|va|gb|ga|vc|ve|fr|fo|fm|fk|fj|vg|vi|fi|eu|et|es|er|eg|ee|ec|dz|do|dm|dk|vn|dj|de|cz|cy|cx|cw|vu|cv|cu|cr|co|cn|cm|cl|ck|ci|ch|cg|cf|cd|cc|ca|wf|bz|by|bw|bv|bt|bs|br|bo|bn|bm|bj|bi|ws|bh|bg|bf|be|bd|bb|ba|az|ax|aw|au|at|as|ye|ar|aq|ao|am|al|yt|ai|za|ag|af|ae|zm|id)\b/;
return{alphaNumericCharsStr:c,domainNameRegex:d,tldRegex:e}}(),a.AnchorTagBuilder=a.Util.extend(Object,{constructor:function(b){a.Util.assign(this,b)},build:function(b){return new a.HtmlTag({tagName:"a",attrs:this.createAttrs(b.getType(),b.getAnchorHref()),innerHtml:this.processAnchorText(b.getAnchorText())})},createAttrs:function(a,b){var c={href:b},d=this.createCssClass(a);return d&&(c.class=d),this.newWindow&&(c.target="_blank",c.rel="noopener noreferrer"),c},createCssClass:function(a){var b=this.className;return b?b+" "+b+"-"+a:""},processAnchorText:function(a){return a=this.doTruncate(a)},doTruncate:function(b){var c=this.truncate;if(!c||!c.length)return b;var d=c.length,e=c.location;return"smart"===e?a.truncate.TruncateSmart(b,d,".."):"middle"===e?a.truncate.TruncateMiddle(b,d,".."):a.truncate.TruncateEnd(b,d,"..")}}),a.htmlParser.HtmlParser=a.Util.extend(Object,{htmlRegex:function(){var a=/!--([\s\S]+?)--/,b=/[0-9a-zA-Z][0-9a-zA-Z:]*/,c=/[^\s"'>\/=\x00-\x1F\x7F]+/,d=/(?:"[^"]*?"|'[^']*?'|[^'"=<>`\s]+)/,e=c.source+"(?:\\s*=\\s*"+d.source+")?";return new RegExp(["(?:","<(!DOCTYPE)","(?:","\\s+","(?:",e,"|",d.source+")",")*",">",")","|","(?:","<(/)?","(?:",a.source,"|","(?:","("+b.source+")","(?:","(?:\\s+|\\b)",e,")*","\\s*/?",")",")",">",")"].join(""),"gi")}(),htmlCharacterEntitiesRegex:/(&nbsp;|&#160;|&lt;|&#60;|&gt;|&#62;|&quot;|&#34;|&#39;)/gi,parse:function(a){for(var b,c,d=this.htmlRegex,e=0,f=[];null!==(b=d.exec(a));){var g=b[0],h=b[3],i=b[1]||b[4],j=!!b[2],k=b.index,l=a.substring(e,k);l&&(c=this.parseTextAndEntityNodes(e,l),f.push.apply(f,c)),h?f.push(this.createCommentNode(k,g,h)):f.push(this.createElementNode(k,g,i,j)),e=k+g.length}if(e<a.length){var m=a.substring(e);m&&(c=this.parseTextAndEntityNodes(e,m),f.push.apply(f,c))}return f},parseTextAndEntityNodes:function(b,c){for(var d=[],e=a.Util.splitAndCapture(c,this.htmlCharacterEntitiesRegex),f=0,g=e.length;f<g;f+=2){var h=e[f],i=e[f+1];h&&(d.push(this.createTextNode(b,h)),b+=h.length),i&&(d.push(this.createEntityNode(b,i)),b+=i.length)}return d},createCommentNode:function(b,c,d){return new a.htmlParser.CommentNode({offset:b,text:c,comment:a.Util.trim(d)})},createElementNode:function(b,c,d,e){return new a.htmlParser.ElementNode({offset:b,text:c,tagName:d.toLowerCase(),closing:e})},createEntityNode:function(b,c){return new a.htmlParser.EntityNode({offset:b,text:c})},createTextNode:function(b,c){return new a.htmlParser.TextNode({offset:b,text:c})}}),a.htmlParser.HtmlNode=a.Util.extend(Object,{offset:void 0,text:void 0,constructor:function(b){if(a.Util.assign(this,b),null==this.offset)throw new Error("`offset` cfg required");if(null==this.text)throw new Error("`text` cfg required")},getType:a.Util.abstractMethod,getOffset:function(){return this.offset},getText:function(){return this.text}}),a.htmlParser.CommentNode=a.Util.extend(a.htmlParser.HtmlNode,{comment:"",getType:function(){return"comment"},getComment:function(){return this.comment}}),a.htmlParser.ElementNode=a.Util.extend(a.htmlParser.HtmlNode,{tagName:"",closing:!1,getType:function(){return"element"},getTagName:function(){return this.tagName},isClosing:function(){return this.closing}}),a.htmlParser.EntityNode=a.Util.extend(a.htmlParser.HtmlNode,{getType:function(){return"entity"}}),a.htmlParser.TextNode=a.Util.extend(a.htmlParser.HtmlNode,{getType:function(){return"text"}}),a.match.Match=a.Util.extend(Object,{constructor:function(a){if(null==a.tagBuilder)throw new Error("`tagBuilder` cfg required");if(null==a.matchedText)throw new Error("`matchedText` cfg required");if(null==a.offset)throw new Error("`offset` cfg required");this.tagBuilder=a.tagBuilder,this.matchedText=a.matchedText,this.offset=a.offset},getType:a.Util.abstractMethod,getMatchedText:function(){return this.matchedText},setOffset:function(a){this.offset=a},getOffset:function(){return this.offset},getAnchorHref:a.Util.abstractMethod,getAnchorText:a.Util.abstractMethod,buildTag:function(){return this.tagBuilder.build(this)}}),a.match.Email=a.Util.extend(a.match.Match,{constructor:function(b){if(a.match.Match.prototype.constructor.call(this,b),!b.email)throw new Error("`email` cfg required");this.email=b.email},getType:function(){return"email"},getEmail:function(){return this.email},getAnchorHref:function(){return"mailto:"+this.email},getAnchorText:function(){return this.email}}),a.match.Hashtag=a.Util.extend(a.match.Match,{constructor:function(b){if(a.match.Match.prototype.constructor.call(this,b),!b.hashtag)throw new Error("`hashtag` cfg required");this.serviceName=b.serviceName,this.hashtag=b.hashtag},getType:function(){return"hashtag"},getServiceName:function(){return this.serviceName},getHashtag:function(){return this.hashtag},getAnchorHref:function(){var a=this.serviceName,b=this.hashtag;switch(a){case"twitter":return"https://twitter.com/hashtag/"+b;case"facebook":return"https://www.facebook.com/hashtag/"+b;case"instagram":return"https://instagram.com/explore/tags/"+b;default:throw new Error("Unknown service name to point hashtag to: ",a)}},getAnchorText:function(){return"#"+this.hashtag}}),a.match.Phone=a.Util.extend(a.match.Match,{constructor:function(b){if(a.match.Match.prototype.constructor.call(this,b),!b.number)throw new Error("`number` cfg required");if(null==b.plusSign)throw new Error("`plusSign` cfg required");this.number=b.number,this.plusSign=b.plusSign},getType:function(){return"phone"},getNumber:function(){return this.number},getAnchorHref:function(){return"tel:"+(this.plusSign?"+":"")+this.number},getAnchorText:function(){return this.matchedText}}),a.match.Twitter=a.Util.extend(a.match.Match,{constructor:function(b){if(a.match.Match.prototype.constructor.call(this,b),!b.twitterHandle)throw new Error("`twitterHandle` cfg required");this.twitterHandle=b.twitterHandle},getType:function(){return"twitter"},getTwitterHandle:function(){return this.twitterHandle},getAnchorHref:function(){return"https://twitter.com/"+this.twitterHandle},getAnchorText:function(){return"@"+this.twitterHandle}}),a.match.Url=a.Util.extend(a.match.Match,{constructor:function(b){if(a.match.Match.prototype.constructor.call(this,b),"scheme"!==b.urlMatchType&&"www"!==b.urlMatchType&&"tld"!==b.urlMatchType)throw new Error('`urlMatchType` cfg must be one of: "scheme", "www", or "tld"');if(!b.url)throw new Error("`url` cfg required");if(null==b.protocolUrlMatch)throw new Error("`protocolUrlMatch` cfg required");if(null==b.protocolRelativeMatch)throw new Error("`protocolRelativeMatch` cfg required");if(null==b.stripPrefix)throw new Error("`stripPrefix` cfg required");this.urlMatchType=b.urlMatchType,this.url=b.url,this.protocolUrlMatch=b.protocolUrlMatch,this.protocolRelativeMatch=b.protocolRelativeMatch,this.stripPrefix=b.stripPrefix},urlPrefixRegex:/^(https?:\/\/)?(www\.)?/i,protocolRelativeRegex:/^\/\//,protocolPrepended:!1,getType:function(){return"url"},getUrlMatchType:function(){return this.urlMatchType},getUrl:function(){var a=this.url;return this.protocolRelativeMatch||this.protocolUrlMatch||this.protocolPrepended||(a=this.url="http://"+a,this.protocolPrepended=!0),a},getAnchorHref:function(){var a=this.getUrl();return a.replace(/&amp;/g,"&")},getAnchorText:function(){var a=this.getMatchedText();return this.protocolRelativeMatch&&(a=this.stripProtocolRelativePrefix(a)),this.stripPrefix&&(a=this.stripUrlPrefix(a)),a=this.removeTrailingSlash(a)},stripUrlPrefix:function(a){return a.replace(this.urlPrefixRegex,"")},stripProtocolRelativePrefix:function(a){return a.replace(this.protocolRelativeRegex,"")},removeTrailingSlash:function(a){return"/"===a.charAt(a.length-1)&&(a=a.slice(0,-1)),a}}),a.matcher.Matcher=a.Util.extend(Object,{constructor:function(a){if(!a.tagBuilder)throw new Error("`tagBuilder` cfg required");this.tagBuilder=a.tagBuilder},parseMatches:a.Util.abstractMethod}),a.matcher.Email=a.Util.extend(a.matcher.Matcher,{matcherRegex:function(){var b=a.RegexLib.alphaNumericCharsStr,c=new RegExp("["+b+"\\-_';:&=+$.,]+@"),d=a.RegexLib.domainNameRegex,e=a.RegexLib.tldRegex;return new RegExp([c.source,d.source,"\\.",e.source].join(""),"gi")}(),parseMatches:function(b){for(var c,d=this.matcherRegex,e=this.tagBuilder,f=[];null!==(c=d.exec(b));){var g=c[0];f.push(new a.match.Email({tagBuilder:e,matchedText:g,offset:c.index,email:g}))}return f}}),a.matcher.Hashtag=a.Util.extend(a.matcher.Matcher,{matcherRegex:new RegExp("#[_"+a.RegexLib.alphaNumericCharsStr+"]{1,139}","g"),nonWordCharRegex:new RegExp("[^"+a.RegexLib.alphaNumericCharsStr+"]"),constructor:function(b){a.matcher.Matcher.prototype.constructor.call(this,b),this.serviceName=b.serviceName},parseMatches:function(b){for(var c,d=this.matcherRegex,e=this.nonWordCharRegex,f=this.serviceName,g=this.tagBuilder,h=[];null!==(c=d.exec(b));){var i=c.index,j=b.charAt(i-1);if(0===i||e.test(j)){var k=c[0],l=c[0].slice(1);h.push(new a.match.Hashtag({tagBuilder:g,matchedText:k,offset:i,serviceName:f,hashtag:l}))}}return h}}),a.matcher.Phone=a.Util.extend(a.matcher.Matcher,{matcherRegex:/(?:(\+)?\d{1,3}[-\040.])?\(?\d{3}\)?[-\040.]?\d{3}[-\040.]\d{4}/g,parseMatches:function(b){for(var c,d=this.matcherRegex,e=this.tagBuilder,f=[];null!==(c=d.exec(b));){var g=c[0],h=g.replace(/\D/g,""),i=!!c[1];f.push(new a.match.Phone({tagBuilder:e,matchedText:g,offset:c.index,number:h,plusSign:i}))}return f}}),a.matcher.Twitter=a.Util.extend(a.matcher.Matcher,{matcherRegex:new RegExp("@[_"+a.RegexLib.alphaNumericCharsStr+"]{1,20}","g"),nonWordCharRegex:new RegExp("[^"+a.RegexLib.alphaNumericCharsStr+"]"),parseMatches:function(b){for(var c,d=this.matcherRegex,e=this.nonWordCharRegex,f=this.tagBuilder,g=[];null!==(c=d.exec(b));){var h=c.index,i=b.charAt(h-1);if(0===h||e.test(i)){var j=c[0],k=c[0].slice(1);g.push(new a.match.Twitter({tagBuilder:f,matchedText:j,offset:h,twitterHandle:k}))}}return g}}),a.matcher.Url=a.Util.extend(a.matcher.Matcher,{matcherRegex:function(){var b=/(?:[A-Za-z][-.+A-Za-z0-9]*:(?![A-Za-z][-.+A-Za-z0-9]*:\/\/)(?!\d+\/?)(?:\/\/)?)/,c=/(?:www\.)/,d=a.RegexLib.domainNameRegex,e=a.RegexLib.tldRegex,f=a.RegexLib.alphaNumericCharsStr,g=new RegExp("["+f+"\\-+&@#/%=~_()|'$*\\[\\]?!:,.;]*["+f+"\\-+&@#/%=~_()|'$*\\[\\]]");return new RegExp(["(?:","(",b.source,d.source,")","|","(","(//)?",c.source,d.source,")","|","(","(//)?",d.source+"\\.",e.source,")",")","(?:"+g.source+")?"].join(""),"gi")}(),wordCharRegExp:/\w/,openParensRe:/\(/g,closeParensRe:/\)/g,constructor:function(b){if(a.matcher.Matcher.prototype.constructor.call(this,b),this.stripPrefix=b.stripPrefix,null==this.stripPrefix)throw new Error("`stripPrefix` cfg required")},parseMatches:function(b){for(var c,d=this.matcherRegex,e=this.stripPrefix,f=this.tagBuilder,g=[];null!==(c=d.exec(b));){var h=c[0],i=c[1],j=c[2],k=c[3],l=c[5],m=c.index,n=k||l,o=b.charAt(m-1);if(a.matcher.UrlMatchValidator.isValid(h,i)&&!(m>0&&"@"===o||m>0&&n&&this.wordCharRegExp.test(o))){if(this.matchHasUnbalancedClosingParen(h))h=h.substr(0,h.length-1);else{var p=this.matchHasInvalidCharAfterTld(h,i);p>-1&&(h=h.substr(0,p))}var q=i?"scheme":j?"www":"tld",r=!!i;g.push(new a.match.Url({tagBuilder:f,matchedText:h,offset:m,urlMatchType:q,url:h,protocolUrlMatch:r,protocolRelativeMatch:!!n,stripPrefix:e}))}}return g},matchHasUnbalancedClosingParen:function(a){var b=a.charAt(a.length-1);if(")"===b){var c=a.match(this.openParensRe),d=a.match(this.closeParensRe),e=c&&c.length||0,f=d&&d.length||0;if(e<f)return!0}return!1},matchHasInvalidCharAfterTld:function(a,b){if(!a)return-1;var c=0;b&&(c=a.indexOf(":"),a=a.slice(c));var d=/^((.?\/\/)?[A-Za-z0-9\u00C0-\u017F\.\-]*[A-Za-z0-9\u00C0-\u017F\-]\.[A-Za-z]+)/,e=d.exec(a);return null===e?-1:(c+=e[1].length,a=a.slice(e[1].length),/^[^.A-Za-z:\/?#]/.test(a)?c:-1)}}),a.matcher.UrlMatchValidator={hasFullProtocolRegex:/^[A-Za-z][-.+A-Za-z0-9]*:\/\//,uriSchemeRegex:/^[A-Za-z][-.+A-Za-z0-9]*:/,hasWordCharAfterProtocolRegex:/:[^\s]*?[A-Za-z\u00C0-\u017F]/,isValid:function(a,b){return!(b&&!this.isValidUriScheme(b)||this.urlMatchDoesNotHaveProtocolOrDot(a,b)||this.urlMatchDoesNotHaveAtLeastOneWordChar(a,b))},isValidUriScheme:function(a){var b=a.match(this.uriSchemeRegex)[0].toLowerCase();return"javascript:"!==b&&"vbscript:"!==b},urlMatchDoesNotHaveProtocolOrDot:function(a,b){return!(!a||b&&this.hasFullProtocolRegex.test(b)||a.indexOf(".")!==-1)},urlMatchDoesNotHaveAtLeastOneWordChar:function(a,b){return!(!a||!b||this.hasWordCharAfterProtocolRegex.test(a))}},a.truncate.TruncateEnd=function(b,c,d){return a.Util.ellipsis(b,c,d)},a.truncate.TruncateMiddle=function(a,b,c){if(a.length<=b)return a;var d=b-c.length,e="";return d>0&&(e=a.substr(-1*Math.floor(d/2))),(a.substr(0,Math.ceil(d/2))+c+e).substr(0,b)},a.truncate.TruncateSmart=function(a,b,c){var d=function(a){var b={},c=a,d=c.match(/^([a-z]+):\/\//i);return d&&(b.scheme=d[1],c=c.substr(d[0].length)),d=c.match(/^(.*?)(?=(\?|#|\/|$))/i),d&&(b.host=d[1],c=c.substr(d[0].length)),d=c.match(/^\/(.*?)(?=(\?|#|$))/i),d&&(b.path=d[1],c=c.substr(d[0].length)),d=c.match(/^\?(.*?)(?=(#|$))/i),d&&(b.query=d[1],c=c.substr(d[0].length)),d=c.match(/^#(.*?)$/i),d&&(b.fragment=d[1]),b},e=function(a){var b="";return a.scheme&&a.host&&(b+=a.scheme+"://"),a.host&&(b+=a.host),a.path&&(b+="/"+a.path),a.query&&(b+="?"+a.query),a.fragment&&(b+="#"+a.fragment),b},f=function(a,b){var d=b/2,e=Math.ceil(d),f=-1*Math.floor(d),g="";return f<0&&(g=a.substr(f)),a.substr(0,e)+c+g};if(a.length<=b)return a;var g=b-c.length,h=d(a);if(h.query){var i=h.query.match(/^(.*?)(?=(\?|\#))(.*?)$/i);i&&(h.query=h.query.substr(0,i[1].length),a=e(h))}if(a.length<=b)return a;if(h.host&&(h.host=h.host.replace(/^www\./,""),a=e(h)),a.length<=b)return a;var j="";if(h.host&&(j+=h.host),j.length>=g)return h.host.length==b?(h.host.substr(0,b-c.length)+c).substr(0,b):f(j,g).substr(0,b);var k="";if(h.path&&(k+="/"+h.path),h.query&&(k+="?"+h.query),k){if((j+k).length>=g){if((j+k).length==b)return(j+k).substr(0,b);var l=g-j.length;return(j+f(k,l)).substr(0,b)}j+=k}if(h.fragment){var m="#"+h.fragment;if((j+m).length>=g){if((j+m).length==b)return(j+m).substr(0,b);var n=g-j.length;return(j+f(m,n)).substr(0,b)}j+=m}if(h.scheme&&h.host){var o=h.scheme+"://";if((j+o).length<g)return(o+j).substr(0,b)}if(j.length<=b)return j;var p="";return g>0&&(p=j.substr(-1*Math.floor(g/2))),(j.substr(0,Math.ceil(g/2))+c+p).substr(0,b)},a});var browserKey="AIzaSyDx5tEfNkixUSvbt9PQReDDJLZI16P4Fmk",youtubeApi=null,country="IN",youtubeApp=angular.module("youtube",["ngTouch","ui.router","duScroll"]);youtubeApp.config(["$stateProvider","$urlMatcherFactoryProvider","$urlRouterProvider","$locationProvider",function(a,b,c,d){b.caseInsensitive(!0),c.otherwise("/"),a.state("home",{views:{header:{templateUrl:"src/js/modules/header/header.html",controller:"headerController"},sidenav:{templateUrl:"src/js/modules/sidenav/sidenav.html",controller:"sidenavController"},videoBar:{templateUrl:"src/js/modules/videoPage/videoPage.html",controller:"videoPageController"}}}).state("home.homePage",{url:"/",templateUrl:"src/js/modules/homePage/homePage.html",controller:"homePageController"}).state("home.searchVideos",{url:"/search?query&pageToken",templateUrl:"src/js/modules/searchVideos/searchVideos.html",controller:"youtubeController"}).state("home.videoPage",{url:"/video/:id"}).state("home.channelPage",{url:"/channel/:id",templateUrl:"src/js/modules/channelPage/channelPage.html",controller:"channelPageController"}).state("home.trending",{url:"/trending/:category?pageToken",templateUrl:"src/js/modules/trendingPage/trendingPage.html",controller:"trendingPageController"}).state("home.about",{url:"/about/",templateUrl:"src/js/modules/about/about.html"}).state("home.channelPage.home",{url:"/home",templateUrl:"src/js/modules/channelPage/channelPageHome/channelPageHome.html",controller:"channelPageHomeController"}).state("home.channelPage.videos",{url:"/videos",templateUrl:"src/js/modules/channelPage/channelPageVideos/channelPageVideos.html",controller:"channelPageVideosController"}).state("home.channelPage.channels",{url:"/channels",templateUrl:"src/js/modules/channelPage/channelPageChannels/channelPageChannels.html",controller:"channelPageChannelsController"}).state("home.channelPage.about",{url:"/about",templateUrl:"src/js/modules/channelPage/channelPageAbout/channelPageAbout.html",controller:"channelPageAboutController"}),d.html5Mode(!0)}]),NProgress.configure({showSpinner:!1});var autolinker=new Autolinker({urls:{schemeMatches:!0,wwwMatches:!0,tldMatches:!0},email:!0,phone:!1,twitter:!1,hashtag:"twitter",stripPrefix:!1,newWindow:!0,truncate:{length:0,location:"end"}});youtubeApp.config(["$compileProvider",function(a){a.debugInfoEnabled(!1)}]),!function(a){youtubeApp.directive("comment",function(){return{restrict:"E",scope:{comment:"="},templateUrl:"src/js/directives/comment/comment.html",controller:["$scope","$sce","searchService",function(a,b,c){if(a.comment.snippet.topLevelComment.snippet.updatedAtFull=moment(a.comment.snippet.topLevelComment.snippet.updatedAt).format("h:mm:ss A, MMMM Do YYYY"),a.comment.snippet.topLevelComment.snippet.updatedAt=moment(a.comment.snippet.topLevelComment.snippet.updatedAt).fromNow(),a.comment.snippet.topLevelComment.snippet.textDisplay=b.trustAsHtml(a.comment.snippet.topLevelComment.snippet.textDisplay),a.comment.replies)for(var d=0;d<a.comment.replies.comments.length;d++)a.comment.replies.comments[d].snippet.textDisplay=b.trustAsHtml(a.comment.replies.comments[d].snippet.textDisplay),a.comment.replies.comments[d].snippet.updatedAtFull=moment(a.comment.replies.comments[d].snippet.updatedAt).format("h:mm:ss A, MMMM Do YYYY"),a.comment.replies.comments[d].snippet.updatedAt=moment(a.comment.replies.comments[d].snippet.updatedAt).fromNow();try{a.comment.snippet.totalReplyCount-a.comment.replies.comments.length>1?a.replyText="Replies":a.replyText="Reply"}catch(a){}a.loadMoreReplies=function(){var d={parentId:a.comment.id,maxResults:a.moreRepliesNextPageToken?4:8,pageToken:a.moreRepliesNextPageToken};a.moreRepliesSpinner=!0,c.getReplies(d).then(function(c){for(var d=0;d<c.items.length;d++)c.items[d].snippet.textDisplay=b.trustAsHtml(c.items[d].snippet.textDisplay),c.items[d].snippet.updatedAtFull=moment(c.items[d].snippet.updatedAt).format("h:mm:ss A, MMMM Do YYYY"),c.items[d].snippet.updatedAt=moment(c.items[d].snippet.updatedAt).fromNow();a.moreRepliesNextPageToken?a.comment.replies.comments=a.comment.replies.comments.concat(c.items):a.comment.replies.comments=a.comment.replies.comments.concat(c.items.slice(a.comment.replies.comments.length,c.items.length)),a.moreRepliesNextPageToken=c.nextPageToken,a.comment.snippet.totalReplyCount-a.comment.replies.comments.length>1?a.replyText="Replies":a.replyText="Reply",a.moreRepliesSpinner=!1})}}]}})}(window.angular),function(a){youtubeApp.directive("imgLoader",function(){return{restrict:"E",scope:{src:"=imgSrc"},templateUrl:"src/js/directives/imgLoader/imgLoader.html",link:function(b,c,d){b.loader=!0,a.element(c.children()[1]).on("load",function(a){b.$apply(b.loader=!1)})}}})}(window.angular),function(a){function b(a,b){var c,d,e,f,g=0,h=function(){g=+new Date,c=null,f=a.apply(d,e),c||(d=e=null)},i=function(){var i=+new Date,j=b-(i-g);return d=this,e=arguments,j<=0||j>b?(c&&(clearTimeout(c),c=null),g=i,f=a.apply(d,e),c||(d=e=null)):c||(c=setTimeout(h,j)),f};return i.cancel=function(){clearTimeout(c),g=0,c=d=e=null},i}youtubeApp.directive("scrollFire",["$compile","$timeout",function(c,d){return{restrict:"A",scope:{offset:"@",scrollFire:"&"},link:function(c,d,e){function f(){a.element(window).off("scroll resize blur focus",i)}var g=c.offset;a.isDefined(c.offset)||(g=0),g=Number(g)||0;var h=!1,i=b(function(){if(!h){var a=window.pageYOffset+window.innerHeight,b=d[0].getBoundingClientRect().top+window.pageYOffset;a>b+g&&(h=!0,c.scrollFire({}),f())}},100);a.element(window).on("scroll resize blur focus",i),i(),c.$on("$destroy",f)}}}])}(window.angular),function(a){youtubeApp.directive("spinner",function(){return{restrict:"E",templateUrl:"src/js/directives/spinner/spinner.html"}})}(window.angular),function(a){youtubeApp.directive("videoCarousel",function(){return{restrict:"E",scope:{category:"=?",channelId:"=?",order:"=?"},templateUrl:"src/js/directives/videoCarousel/videoCarousel.html",controller:["$rootScope","$scope","$sce","searchService",function(a,b,c,d){var e=function(){return a.isMobile?2:a.isTablet?4:6};b.$watch("$root.isMobile.toLocaleString()+$root.isTablet.toLocaleString()",function(a,c){a!=c&&b.scrollFireLoad()}),b.loader=!0,b.setMinHeight=function(){if(!b.loader&&!b.videos.length)return{"min-height":"100px"}},b.nextOrPrev=function(a){b.loader=!0,b.isNextClicked=a;var c=null;c=b.category?{pageToken:a?b.nextPageToken:b.prevPageToken,videoCategoryId:b.category.id,part:"snippet,statistics,contentDetails",maxResults:e(),chart:"mostPopular"}:{order:b.order.value,channelId:b.channelId,part:"snippet",maxResults:e(),pageToken:a?b.nextPageToken:b.prevPageToken},f(c)},b.scrollFireLoad=function(){var a=null;b.category?(b.title=b.category.snippet.title,a={videoCategoryId:b.category.id,part:"snippet,statistics,contentDetails",maxResults:e(),chart:"mostPopular"}):(b.title=b.order.title,a={order:b.order.value,channelId:b.channelId,part:"snippet",maxResults:e()}),f(a)};var f=function(a){b.category?d.getVideos(a).then(function(a){for(var c=0;c<a.items.length;c++)a.items[c].snippet.publishedAt=moment(a.items[c].snippet.publishedAt).fromNow(),a.items[c].videoId=a.items[c].id;b.nextPageToken=a.nextPageToken,b.prevPageToken=a.prevPageToken,b.videos=a.items,b.loader=!1}):d.searchVideos(a).then(function(a){b.videos=a.items,b.nextPageToken=a.nextPageToken,b.prevPageToken=a.prevPageToken,b.loader=!1;for(var c={videos:b.videos,part:"statistics,contentDetails"},e=0;e<a.items.length;e++)b.videos[e].snippet.publishedAt=moment(b.videos[e].snippet.publishedAt).fromNow(),b.videos[e].videoId=b.videos[e].id.videoId;d.getVideoDetails(c).then(function(a){for(var c=0;c<a.length;c++)b.videos[c].statistics=a[c].statistics,b.videos[c].contentDetails=a[c].contentDetails})})}}]}})}(window.angular),function(a){youtubeApp.directive("videoItem",function(){return{restrict:"E",scope:{video:"=",videoDetail:"=",hideChannel:"="},templateUrl:"src/js/directives/videoItem/videoItem.html",link:function(a,b,c){a.$watch("video",function(){a.video.snippet.publishedAt=moment(a.video.snippet.publishedAt).fromNow()})}}})}(window.angular),function(a){youtubeApp.factory("iframeApiService",["$q","$window",function(a,b){var c={},d=a.defer();return b.onYouTubeIframeAPIReady=function(){d.resolve()},c.onApiReady=function(a){d.promise.then(a)},c}]),youtubeApp.directive("youtubeVideo",["iframeApiService",function(a){return{restrict:"E",scope:{videoId:"@",player:"=",stateChangeCallback:"&"},template:"<div></div>",link:function(b,c,d){var e=document.createElement("script");e.src="https://www.youtube.com/iframe_api";var f=document.getElementsByTagName("script")[0];f.parentNode.insertBefore(e,f);var g;a.onApiReady(function(){g=new YT.Player(c.children()[0],{playerVars:{autoplay:1,modestbranding:1,showinfo:0,rel:0},videoId:b.videoId,events:{onReady:h,onStateChange:b.stateChangeCallback()}})});var h=function(){g.playVideo(),b.player=g};b.$watch("videoId",function(a,b){a!=b&&(g.cueVideoById(a),g.playVideo())})}}}])}(window.angular),youtubeApp.factory("searchService",["$q","$http",function(a,b){var c={};c.searchVideos=function(b){var c=a.defer();return youtubeApi.then(function(){gapi.client.youtube.search.list({channelId:b.channelId,order:b.order,part:"snippet",type:"video",regionCode:country,maxResults:b.maxResults?b.maxResults:12,relatedToVideoId:b.relatedToVideoId,q:b.query,pageToken:b.pageToken}).then(function(a){c.resolve(a.result)})}),c.promise},c.getSearchSuggestion=function(c){var d=a.defer();return b({method:"JSONP",headers:{"Access-Control-Allow-Origin":"*","Access-Control-Allow-Methods":"POST, GET, OPTIONS, PUT","Content-Type":"application/json",Accept:"application/json"},url:"http://suggestqueries.google.com/complete/search?callback=JSON_CALLBACK&ds=yt&client=firefox&hl=en&q="+c}).success(function(a){d.resolve(a)}),d.promise},c.getVideos=function(b){var c=a.defer();return youtubeApi.then(function(){gapi.client.youtube.videos.list({regionCode:country,chart:b.chart,maxResults:b.maxResults,pageToken:b.pageToken,part:b.part,id:b.videoId,videoCategoryId:b.videoCategoryId,fields:b.fields}).then(function(a){try{for(var b=0;b<a.result.items.length;b++)a.result.items[b].contentDetails.duration=moment.duration(a.result.items[b].contentDetails.duration).format("h:m:ss"),a.result.items[b].contentDetails.duration=a.result.items[b].contentDetails.duration.includes(":")?a.result.items[b].contentDetails.duration:"0:"+a.result.items[b].contentDetails.duration,a.result.items[b].statistics.viewCount=parseInt(a.result.items[b].statistics.viewCount).toLocaleString()}catch(a){}c.resolve(a.result)})}),c.promise},c.getVideoDetails=function(b){var c=a.defer();return youtubeApi.then(function(){gapi.client.youtube.videos.list({part:b.part,id:f(b.videos),fields:b.fields}).then(function(a){try{for(var b=0;b<a.result.items.length;b++)a.result.items[b].contentDetails.duration=moment.duration(a.result.items[b].contentDetails.duration).format("h:m:ss"),a.result.items[b].contentDetails.duration=a.result.items[b].contentDetails.duration.includes(":")?a.result.items[b].contentDetails.duration:"0:"+a.result.items[b].contentDetails.duration,a.result.items[b].statistics.viewCount=parseInt(a.result.items[b].statistics.viewCount).toLocaleString()}catch(a){}c.resolve(a.result.items)})}),c.promise},c.getMappedChannels=function(b){var c=a.defer();return youtubeApi.then(function(){gapi.client.youtube.channels.list({part:"snippet",id:e(b.videosToMap),fields:b.fields}).then(function(a){var e=d(b.videosToMap,a.result.items);c.resolve(e)})}),c.promise},c.getChannel=function(b){var c=a.defer();return youtubeApi.then(function(){gapi.client.youtube.channels.list({part:b.part,id:b.channelId,fields:b.fields}).then(function(a){c.resolve(a.result.items[0])})}),c.promise},c.getVideoCategories=function(){var b=a.defer();return youtubeApi.then(function(){gapi.client.youtube.videoCategories.list({part:"snippet",regionCode:country}).then(function(a){b.resolve(a.result.items)})}),b.promise},c.getChannels=function(b){var c=a.defer();return youtubeApi.then(function(){gapi.client.youtube.channels.list({part:b.part,id:b.channelIds,fields:b.fields}).then(function(a){c.resolve(a.result.items)})}),c.promise},c.getCommentThreads=function(b){var c=a.defer();return youtubeApi.then(function(){gapi.client.youtube.commentThreads.list({part:"snippet,replies",videoId:b.videoId,pageToken:b.pageToken,maxResults:8,order:b.order,fields:"items(id,replies(comments(id,snippet(authorChannelUrl,authorProfileImageUrl,authorDisplayName,canRate,likeCount,publishedAt,textDisplay,updatedAt))),snippet(canReply,topLevelComment(snippet(authorChannelUrl,authorDisplayName,authorProfileImageUrl,canRate,likeCount,publishedAt,textDisplay,updatedAt)),totalReplyCount)),nextPageToken"}).then(function(a){c.resolve(a.result)},function(a){c.reject(a.result)})}),c.promise},c.getReplies=function(b){var c=a.defer();return youtubeApi.then(function(){gapi.client.youtube.comments.list({part:"snippet",parentId:b.parentId,pageToken:b.pageToken,maxResults:b.maxResults}).then(function(a){c.resolve(a.result)},function(a){c.reject(a.result)})}),c.promise},c.getSubscriptions=function(b){var c=a.defer();return youtubeApi.then(function(){gapi.client.youtube.subscriptions.list({part:b.part,channelId:b.channelId,maxResults:b.maxResults,order:b.order,fields:b.fields}).then(function(a){c.resolve(a.result)},function(a){c.reject(a.result)})}),c.promise};var d=function(a,b){for(var c=[],d=0;d<a.length;d++)for(var e=0;e<b.length;e++)if(b[e].id==a[d].snippet.channelId){c[d]={},c[d].channelThumbnail=b[e].snippet.thumbnails.default.url;break}return c},e=function(a){for(var b="",c=a.length-1;c>=0;c--)b+=a[c].snippet.channelId+",";return b},f=function(a){for(var b="",c=0;c<a.length;c++)b+=a[c].id.videoId+",";return b};return c}]),!function(a){youtubeApp.controller("channelPageAboutController",["$document","$scope","$state","$stateParams","searchService",function(b,c,d,e,f){c.init=function(){a.element(b).scrollTo(0,0,700);var d={part:"statistics",channelId:e.id};f.getChannel(d).then(function(a){a.statistics.viewCount=parseInt(a.statistics.viewCount).toLocaleString(),a.statistics.subscriberCount=parseInt(a.statistics.subscriberCount).toLocaleString(),a.statistics.videoCount=parseInt(a.statistics.videoCount).toLocaleString(),c.$parent.channel.statistics=a.statistics})}}])}(window.angular),function(a){youtubeApp.controller("channelPageChannelsController",["$document","$scope","$state","$stateParams","searchService",function(b,c,d,e,f){c.init=function(){a.element(b).scrollTo(0,0,700),c.loaderFeatured=!0,c.$parent.deferedChannel.promise.then(function(a){if(!a.brandingSettings.channel.featuredChannelsUrls)return void(c.loaderFeatured=!1);for(var b=[],d=0;d<a.brandingSettings.channel.featuredChannelsUrls.length;d++)b+=a.brandingSettings.channel.featuredChannelsUrls[d]+",";var e={channelIds:b,part:"snippet",fields:"items(id,snippet(thumbnails/medium,title))"};f.getChannels(e).then(function(a){c.featuredChannels=a,c.loaderFeatured=!1})}),c.loaderSubscribed=!0,c.subscriptionsAllowed=!0;var d={part:"snippet",channelId:e.id,maxResults:50,fields:"items(snippet(resourceId/channelId,thumbnails/medium,title))"};f.getSubscriptions(d).then(function(a){a.items.length&&(c.subscribedChannels=a.items,c.loaderSubscribed=!1)},function(a){c.subscriptionsAllowed=!1,c.loaderSubscribed=!1})}}])}(window.angular),function(a){youtubeApp.controller("channelPageController",["$q","$document","$rootScope","$scope","$state","$stateParams","searchService",function(a,b,c,d,e,f,g){d.init=function(){var e={part:"snippet,brandingSettings",channelId:f.id,fields:"items(brandingSettings(channel(description,featuredChannelsTitle,featuredChannelsUrls),image(bannerMobileImageUrl,bannerTabletImageUrl)),snippet(description,publishedAt,thumbnails/medium,title))"};d.deferedChannel=a.defer(),d.channel={},g.getChannel(e).then(function(a){d.channel.brandingSettings=a.brandingSettings,d.channel.snippet=a.snippet,d.channel.snippet.publishedAt=moment(d.channel.snippet.publishedAt).format("Do MMM, YYYY"),d.channel.brandingSettings||(d.channel.brandingSettings={}),d.channel.brandingSettings.channel||(d.channel.brandingSettings.channel={}),d.channel.brandingSettings.channel.featuredChannelsTitle=d.channel.brandingSettings.channel.featuredChannelsTitle?d.channel.brandingSettings.channel.featuredChannelsTitle:"Featured Channels",d.channel.snippet.description=d.channel.snippet.description?d.channel.snippet.description:"No Description Available",d.deferedChannel.resolve(d.channel)}),b.on("scroll",function(){var a=document.getElementById("channel-banner").getBoundingClientRect();a.bottom<(c.isMobile?56:64)?"channel-tab-main-div-fixed"!=d.channelTab&&(d.$digest(d.channelTab="channel-tab-main-div-fixed"),d.$digest(d.channelTabContent="channel-tab-content-fixed")):"channel-tab-main-div"!=d.channelTab&&(d.$digest(d.channelTab="channel-tab-main-div"),d.$digest(d.channelTabContent=""))}),d.$on("$destroy",function(){b.unbind("scroll")})}}])}(window.angular),function(a){youtubeApp.controller("channelPageHomeController",["$document","$scope","$state","$stateParams","searchService",function(b,c,d,e,f){c.init=function(){a.element(document).scrollTo(0,0,700),c.channelId=e.id,c.mostPopular={title:"Most Popular",value:"viewCount"},c.recent={title:"Recently Uploaded",value:"date"}}}])}(window.angular),function(a){youtubeApp.controller("channelPageVideosController",["$document","$scope","$state","$stateParams","searchService",function(b,c,d,e,f){c.init=function(){a.element(document).scrollTo(0,0,700),c.loaderVideos=!0;var b={channelId:e.id,order:"date",maxResults:24};f.searchVideos(b).then(function(a){c.videos=a.items,c.loaderVideos=!1,c.nextPageToken=a.nextPageToken;var b={videos:c.videos,part:"statistics,contentDetails"};f.getVideoDetails(b).then(function(a){c.videoDetails=a;
})}),c.loadMoreVideos=function(){var a={channelId:e.id,order:"date",pageToken:c.nextPageToken};c.loaderVideos=!0,c.nextPageToken=!1,f.searchVideos(a).then(function(a){c.videos=c.videos.concat(a.items),c.loaderVideos=!1,c.nextPageToken=a.nextPageToken;var b={videos:a.items,part:"statistics,contentDetails"};f.getVideoDetails(b).then(function(a){c.videoDetails=c.videoDetails.concat(a)})})}}}])}(window.angular),function(a){youtubeApp.controller("headerController",["$timeout","$window","$rootScope","$scope","$state","$location","searchService",function(b,c,d,e,f,g,h){e.fetchSearchSuggestion=function(){e.query&&(e.tinySpinner=!0,h.getSearchSuggestion(e.query).then(function(a){e.tinySpinner=!1,e.selectedIndex=-1,e.items=a,0!=a[1].length&&e.search_li?e.searchSuggestion=!0:e.searchSuggestion=!1}))},e.suggestionClick=function(a){e.query=a,e.submit()},e.searchFocused=function(){e.search_ul="nav-items-focus right",e.search_li="search-item-li-focus",e.mobileSearchFocus="mobile-search-focus",b(function(){e.crossSign=!0},400),e.searchSuggestion=!0,e.fetchSearchSuggestion(),e.items=[]},e.searchBlured=function(){e.search_ul="right nav-items",e.search_li="",b(function(){e.mobileSearchFocus=""},100),e.crossSign=!1,e.searchSuggestion=!1,e.selectedIndex=-1,e.items=[]},e.submit=function(){f.go("home.searchVideos",{query:e.query,pageToken:null})},e.inputKeypress=function(a){38==a.keyCode&&a.preventDefault(),13==a.keyCode?(a.target.blur(),e.submit()):40==a.keyCode&&e.items[1].length>e.selectedIndex+1&&e.items!=[]?(e.selectedIndex++,e.query=e.items[1][e.selectedIndex]):38==a.keyCode&&e.selectedIndex>0&&e.items!=[]&&(e.selectedIndex--,e.query=e.items[1][e.selectedIndex])},e.mouseOver=function(a){e.selectedIndex=a},e.init=function(){g.search().query?e.query=g.search().query:e.query="",e.searchBlured(),d.$on("$stateChangeStart",function(a,b){}),d.$on("$stateChangeSuccess",function(a){}),d.hideAppLoader=!1;var b=function(){c.innerWidth<601?(d.isMobile=!0,d.isTablet=!1,d.mobilePaddingMargin="zero-padding zero-margin"):c.innerWidth<1025?(d.isMobile=!1,d.isTablet=!0,d.mobilePaddingMargin=""):(d.isMobile=!1,d.isTablet=!1,d.mobilePaddingMargin="")};a.element(c).on("resize",function(){e.$apply(function(){b()})}),b()}}])}(window.angular),function(a){youtubeApp.controller("homePageController",["$scope","$state","searchService","$stateParams",function(a,b,c,d){a.videoCategories=[{snippet:{title:"Popular Now"}},{id:10,snippet:{title:"Music"}},{id:23,snippet:{title:"Comedy"}},{id:1,snippet:{title:"Film & Animation"}},{id:17,snippet:{title:"Sports"}},{id:28,snippet:{title:"Technology"}},{id:19,snippet:{title:"Travel & Events"}},{id:27,snippet:{title:"Education"}},{id:22,snippet:{title:"People & Blogs"}}]}])}(window.angular),function(a){youtubeApp.controller("youtubeController",["$rootScope","$scope","$state","searchService","$stateParams",function(a,b,c,d,e){b.submit=function(){b.preloader=!0,b.videos=!1,b.nextPageToken=!1,b.prevPageToken=!1;var a={pageToken:e.pageToken,query:e.query,maxResults:16};d.searchVideos(a).then(function(a){b.videos=a.items,b.nextPageToken=a.nextPageToken,b.prevPageToken=a.prevPageToken,b.preloader=!1;var c={videos:b.videos,part:"statistics,contentDetails"};d.getVideoDetails(c).then(function(a){b.videoDetails=a})})},b.nextOrPrev=function(a){c.go("home.searchVideos",{query:e.query,pageToken:a})},b.init=function(){b.submit(),b.$on("$destroy",function(){a.$$childHead.query=""})}}])}(window.angular),function(a){youtubeApp.controller("sidenavController",["$scope","$state","$stateParams","$rootScope",function(a,b,c,d){a.init=function(){d.isMobile||d.isTablet?(d.sidenavMargin="side-nav-margin-off",d.sidenavLeft="side-nav-off",d.isSideNavOn=!1):(d.sidenavMargin="side-nav-margin-on",d.sidenavLeft="side-nav-on",d.isSideNavOn=!0),d.toggleSidenav=function(){d.isSideNavOn?(d.sidenavMargin="side-nav-margin-off",d.sidenavLeft="side-nav-off",d.isSideNavOn=!1):(d.sidenavMargin="side-nav-margin-on",d.sidenavLeft="side-nav-on",d.isSideNavOn=!0)}}}])}(window.angular),function(a){youtubeApp.controller("trendingPageController",["$rootScope","$scope","$state","searchService","$stateParams",function(a,b,c,d,e){b.init=function(){var a;switch(e.category){case"music":b.title="Trending in Music",a=10;break;case"sports":b.title="Trending in Sports",a=17;break;case"technology":b.title="Trending in Technology",a=28;break;case"movies":b.title="Trending in Movies",a=1;break;case"comedy":b.title="Trending in Comedy",a=23;break;case"education":b.title="Trending in Education",a=27;break;default:b.title="Trending Videos",a=null}b.loader=!0,parameters={videoCategoryId:a,part:"snippet,statistics,contentDetails",maxResults:12,chart:"mostPopular",pageToken:e.pageToken},d.getVideos(parameters).then(function(a){for(var c=0;c<a.items.length;c++){var d=a.items[c].id;a.items[c].id={},a.items[c].id.videoId=d}b.nextPageToken=a.nextPageToken,b.prevPageToken=a.prevPageToken,b.videos=a.items,b.loader=!1})},b.nextOrPrev=function(a){c.go("home.trending",{category:e.category,pageToken:a})}}])}(window.angular),function(a){youtubeApp.controller("videoPageController",["$document","$sce","$rootScope","$scope","$state","$stateParams","$timeout","searchService","$interval",function(b,c,d,e,f,g,h,i,j){function k(a){if(1==a)return e.progressBarWidth={width:"0%"},e.bufferBarWidth={width:"0%"},void(e.video.currentTime="0:00");try{var b=e.player.getCurrentTime()/e.player.getDuration()*100;e.progressBarWidth={width:isNaN(b)?0:b+"%"};var c=100*e.player.getVideoLoadedFraction();e.bufferBarWidth={width:c+"%"},e.video.currentTime=moment.duration({seconds:e.player.getCurrentTime()}).format("hh:mm:ss"),e.video.currentTime.indexOf(":")==-1&&(e.video.currentTime="0:"+e.video.currentTime)}catch(a){}}e.formatVideoDetails=function(){moment().format("M D YY")==moment(e.video.snippet.publishedAt).format("M D YY")?e.uploadedTime=moment(e.video.snippet.publishedAt).fromNow():e.uploadedTime=moment(e.video.snippet.publishedAt).format("Do MMMM YYYY"),e.likeCount=isNaN(parseInt(e.video.statistics.likeCount))?0:parseInt(e.video.statistics.likeCount),e.dislikeCount=isNaN(parseInt(e.video.statistics.dislikeCount))?0:parseInt(e.video.statistics.dislikeCount),e.dislikeWidth={width:e.dislikeCount/(e.likeCount+e.dislikeCount)*100+"%"},e.video.snippet.description.length>300?(e.isExpandable=!0,e.expandDescriptionBar="Expand Description",e.expandDescription=function(){"expanded-description"==e.description?(e.description="",e.expandDescriptionBar="Expand Description",a.element(b).scrollToElementAnimated(videoInfo)):(e.description="expanded-description",e.expandDescriptionBar="Collapse Description")}):e.isExpandable=!1},e.loadMoreComments=function(a){var b={videoId:e.videoId,pageToken:a,order:e.order};e.commentsLoader=!0,i.getCommentThreads(b).then(function(a){e.comments.items=e.comments.items.concat(a.items),e.comments.nextPageToken=a.nextPageToken,e.commentsLoader=!1})},e.sortComments=function(a){if(e.videoId){a&&(e.order=a);var b={videoId:e.videoId,order:e.order?e.order:"relevance"};e.commentsLoader=!0,e.comments=null,i.getCommentThreads(b).then(function(a){e.comments=a,e.commentsLoader=!1},function(a){(a.error.errors[0].reason="commentsDisabled")&&(e.commentsEnabled=!1)})}},e.loadMoreVideos=function(){var a={relatedToVideoId:e.videoId,maxResults:8,pageToken:e.nextPageToken};e.loaderVideos=!0,e.nextPageToken=!1,i.searchVideos(a).then(function(a){e.relatedVideos=e.relatedVideos.concat(a.items),e.nextPageToken=a.nextPageToken,e.loaderVideos=!1;var b={videos:e.relatedVideos,part:"statistics,contentDetails"};i.getVideoDetails(b).then(function(a){e.videoDetails=e.videoDetails.concat(a)})})},e.loadRelatedVideos=function(){e.loaderVideos=!0,e.nextPageToken=!1;var a={relatedToVideoId:e.videoId,maxResults:20};i.searchVideos(a).then(function(a){e.relatedVideos=a.items,e.nextPageToken=a.nextPageToken,e.loaderVideos=!1;var b={videos:e.relatedVideos,part:"statistics,contentDetails"};i.getVideoDetails(b).then(function(a){e.videoDetails=a})})},d.$on("$stateChangeStart",function(c,d){"home.videoPage"==d.name?(e.barModeAfterSlide=!1,h(function(){e.barMode=!1},0),a.element(b).scrollTo(0,0,0)):(NProgress.start(),h(function(){e.barModeAfterSlide=!0},400),h(function(){e.barMode=!0},0))}),d.$on("$stateChangeSuccess",function(a,b,c){"home.videoPage"==b.name?c.id!=g.id?(e.changeVideo(c.id),NProgress.inc(),h(NProgress.inc,300),h(NProgress.done,600)):NProgress.done():(NProgress.inc(),h(NProgress.inc,300),h(NProgress.done,600))}),f.params.id||(e.barMode=!0,e.barModeAfterSlide=!0),e.init=function(){if(a.element(b).scrollTo(0,0,700),e.videoId=f.params.id,e.commentsEnabled=!0,e.commentsLoader=!0,e.videoId){var d={videoId:e.videoId,part:"snippet,statistics,contentDetails",fields:"items(contentDetails(duration),snippet(publishedAt,channelId,description,title,thumbnails(medium/url,standard/url)),statistics(commentCount,dislikeCount,likeCount,viewCount))"};i.getVideos(d).then(function(a){e.video=a.items[0],k(!0),e.video.snippet.descriptionHTML=c.trustAsHtml(autolinker.link(e.video.snippet.description)),e.formatVideoDetails();var b={part:"snippet",channelId:e.video.snippet.channelId,fields:"items(id,snippet(thumbnails/default,title))"};i.getChannel(b).then(function(a){e.channel=a,NProgress.done()})})}},e.changeVideo=function(a){NProgress.start(),e.videoId=a,f.go("home.videoPage",{id:a},{notify:!1}),g.id=a,e.init(),e.loadRelatedVideos(),e.sortComments(),e.commentsEnabled=!0,"Collapse Description"==e.expandDescriptionBar&&e.expandDescription()},e.playPauseVideo=function(){e.isPlaying?e.player.pauseVideo():e.player.playVideo(),e.isPlaying=!e.isPlaying},e.onPlayerStateChange=function(a){var b=a.data;b==YT.PlayerState.PLAYING?(e.isPlaying=!0,e.isBuffering=!1,e.cleanupPromise=j(k,1e3)):(j.cancel(e.cleanupPromise),b==YT.PlayerState.BUFFERING?e.isBuffering=!0:e.isBuffering=!1,e.isPlaying=!1),e.$apply()}}])}(window.angular),angular.module("youtube").run(["$templateCache",function(a){"use strict";a.put("src/js/directives/comment/comment.html",'<li class="collection-item avatar" style="border-bottom: 1px solid #e0e0e0; min-height: 60px"><a ui-sref="home.channelPage.home({id: comment.snippet.topLevelComment.snippet.authorChannelUrl.substring(31)})"><img class=circle ng-src={{::comment.snippet.topLevelComment.snippet.authorProfileImageUrl}}> </a><a ui-sref="home.channelPage.home({id: comment.snippet.topLevelComment.snippet.authorChannelUrl.substring(31)})"><strong style="font-size: .95em" class=title>{{::comment.snippet.topLevelComment.snippet.authorDisplayName}}</strong> </a><span title={{::comment.snippet.topLevelComment.snippet.updatedAtFull}} style="font-size: .85em; color: #727272; cursor: default">&nbsp;&nbsp;&nbsp;{{::comment.snippet.topLevelComment.snippet.updatedAt}}</span><br><span style="font-size: .90em" ng-bind-html=comment.snippet.topLevelComment.snippet.textDisplay></span><ul class=collection ng-if=comment.replies style="border:none; margin-bottom: -10px;left: -30px;width: calc(100% + 50px)"><li style=min-height:60px class="collection-item avatar" ng-repeat="reply in comment.replies.comments"><a ui-sref="home.channelPage.home({id: reply.snippet.authorChannelUrl.substring(31)})"><img class=circle ng-src={{::reply.snippet.authorProfileImageUrl}}> </a><a ui-sref="home.channelPage.home({id: reply.snippet.authorChannelUrl.substring(31)})"><strong style="font-size: .95em" class=title>{{::reply.snippet.authorDisplayName}}</strong> </a><span title={{::reply.snippet.updatedAtFull}} style="font-size: .85em; color: #727272; cursor: default">&nbsp;&nbsp;&nbsp;{{::reply.snippet.updatedAt}}</span><br><span style="font-size: .90em" ng-bind-html=reply.snippet.textDisplay></span></li><span ng-hide=moreRepliesSpinner ng-click=loadMoreReplies() class=more-replies ng-if="comment.snippet.totalReplyCount>comment.replies.comments.length">Show {{comment.snippet.totalReplyCount-comment.replies.comments.length}} More {{replyText}} </span><span class="tiny-spinner more-replies-spinner" ng-show=moreRepliesSpinner></span></ul></li>'),a.put("src/js/directives/imgLoader/imgLoader.html","<div class=progress ng-show=loader><div class=indeterminate></div></div><img id=thumb src={{src}}>"),a.put("src/js/directives/spinner/spinner.html",'<div class="preloader-wrapper active"><div class="spinner-layer spinner-blue"><div class="circle-clipper left"><div class=circle></div></div><div class=gap-patch><div class=circle></div></div><div class="circle-clipper right"><div class=circle></div></div></div><div class="spinner-layer spinner-red"><div class="circle-clipper left"><div class=circle></div></div><div class=gap-patch><div class=circle></div></div><div class="circle-clipper right"><div class=circle></div></div></div><div class="spinner-layer spinner-yellow"><div class="circle-clipper left"><div class=circle></div></div><div class=gap-patch><div class=circle></div></div><div class="circle-clipper right"><div class=circle></div></div></div><div class="spinner-layer spinner-green"><div class="circle-clipper left"><div class=circle></div></div><div class=gap-patch><div class=circle></div></div><div class="circle-clipper right"><div class=circle></div></div></div></div>'),a.put("src/js/directives/videoCarousel/videoCarousel.html",'<div scroll-fire=scrollFireLoad() ng-style=setMinHeight() class="section section-carousel pos-rel"><span style=font-size:24px>{{::title}}</span><div ng-if=prevPageToken ng-click=nextOrPrev(false) class="hoverable prev-carousel pointer"><i class=material-icons>keyboard_arrow_left</i></div><div style="overflow-x: hidden"><div ng-class="loader?(isNextClicked?\'slide-left\':\'slide-right\'):\'\'" class="row zero-margin"><div ng-if="!loader && !videos.length" class=center style="margin: 30px 0px 10px 0px"><i class="material-icons channel-tab-icons">error</i> <span>No Videos Available</span></div><div ng-swipe-right="prevPageToken && nextOrPrev(false)" ng-swipe-left="nextPageToken && nextOrPrev(true)" class="col s6 m3 l2" ng-repeat="video in videos"><div class="card-click hoverable card"><div class="card-image waves-effect waves-block waves-light" style="padding-top: 56.25%; z-index:0"><a style="position: absolute;  top: 0; bottom: 0; left: 0; right: 0" ui-sref="home.videoPage({id: video.videoId})"><img ng-src={{video.snippet.thumbnails.medium.url}}><div class=video-info-bar-carousel><div class=video-duration-carousel><span>{{::video.snippet.publishedAt}} </span><span style=float:right>{{::video.contentDetails.duration}}</span></div></div></a></div><a ui-sref="home.videoPage({id: video.videoId})" style="display:block;padding:5px 6px 2px 6px" class=card-content><span style="height: 32px" class="card-title video-title-carousel">{{video.snippet.title}}</span><div class=video-views-carousel>{{::video.statistics.viewCount}} Views</div></a><a ng-if=category ui-sref="home.channelPage.home({id: video.snippet.channelId})" class="video-channel-carousel truncate">{{::video.snippet.channelTitle}}</a></div></div></div><div ng-if=loader style="position: absolute;bottom: 30%;left: 46%" class="preloader-wrapper small active"><div class="spinner-layer spinner-red-only"><div class="circle-clipper left"><div class=circle></div></div><div class=gap-patch><div class=circle></div></div><div class="circle-clipper right"><div class=circle></div></div></div></div></div><div ng-if=nextPageToken ng-click=nextOrPrev(true) class="hoverable next-carousel pointer"><i class=material-icons>keyboard_arrow_right</i></div></div><div class=divider></div>'),a.put("src/js/directives/videoItem/videoItem.html",'<div class="card-click hoverable card"><div class="card-image waves-effect waves-block waves-light" style="padding-top: 56.25%"><a style="position: absolute;  top: 0; bottom: 0; left: 0; right: 0" ui-sref="home.videoPage({id: video.id.videoId})"><img ng-src={{video.snippet.thumbnails.medium.url}}><div class=video-info-bar-carousel><div class=video-duration-carousel><span>{{video.snippet.publishedAt}} </span><span style=float:right>{{videoDetail.contentDetails.duration}}</span></div></div></a></div><a ui-sref="home.videoPage({id: video.id.videoId})" style="display:block;padding:5px 6px 2px 6px" class=card-content><span style="height: 32px" class="card-title video-title-carousel">{{video.snippet.title}}</span><div class=video-views-carousel>{{videoDetail.statistics.viewCount}} Views</div></a><a ng-hide=hideChannel ui-sref="home.channelPage.home({id: video.snippet.channelId})" class="video-channel-carousel truncate">{{video.snippet.channelTitle}}</a></div>'),a.put("src/js/modules/about/about.html",'<br><div class="row container"><div class="col s12"><div class=card><div class=card-content><span class=card-title>About Youtube Material</span><p>Hi. I\'m Pranav Jindal.<br>This project is my na\xefve attempt aimed at making a simple Material version of YouTube using Google APIs, AngularJS and MaterializeCSS.<br>I make this project in my leisure time just to improve my front-end skills.<br><br>The code for the project is at following repo:<br><a href=https://github.com/pranavjindal999/Youtube-Material target=_blank>Youtube Material - Github</a><br><br>Feel free to contact me via any of the following media:<br><br></p><div class=card-action></div><div class=row><a target=_blank class="socicon-linkedin socicon" title=LinkedIn href=https://www.linkedin.com/in/pranavjindal999></a> <a target=_blank class="socicon-github socicon" title=Github href=https://www.github.com/pranavjindal999></a> <a target=_blank class="socicon-telegram socicon" title=Telegram href=https://www.telegram.me/pranavjindal999></a> <a target=_blank class="socicon-facebook socicon" title=Facebook href=https://www.facebook.com/pranavjindal999></a> <a target=_blank class="socicon-twitter socicon" title=Twitter href=https://www.twitter.com/pranavjindal999></a></div><p></p></div></div></div></div>'),a.put("src/js/modules/channelPage/channelPage.html",'<img ng-src={{isMobile?channel.brandingSettings.image.bannerMobileImageUrl:channel.brandingSettings.image.bannerTabletImageUrl}} style="width: 100%;min-height:75px"><div id=channel-banner class=channel-main-div><img class="circle channel-main-div-img" ng-src={{::channel.snippet.thumbnails.medium.url}}><h4 class=channel-main-div-title>{{::channel.snippet.title}}</h4></div><div ng-class=channelTab ng-init=init() class=channel-tab-main-div><div class=hide-on-med-and-down ng-show=channelTabContent><img class="circle channel-tab-small-img" ng-src={{::channel.snippet.thumbnails.medium.url}}></div><div class=channel-tab-ul><ul class="tabs pointer"><li ui-sref-active=channel-tab-highlight ui-sref=home.channelPage.home class="waves-effect waves-block waves-light tab channel-tab-bg"><a class=white-text><i class="material-icons channel-tab-icons">home</i> <span class=hide-on-small-only>Home</span></a></li><li ui-sref-active=channel-tab-highlight ui-sref=home.channelPage.videos class="waves-effect waves-block waves-light tab channel-tab-bg"><a class=white-text><i class="material-icons channel-tab-icons">video_library</i> <span class=hide-on-small-only>Videos</span></a></li><li ui-sref-active=channel-tab-highlight ui-sref=home.channelPage.channels class="waves-effect waves-block waves-light tab channel-tab-bg"><a class=white-text><i class="material-icons channel-tab-icons">tv</i> <span class=hide-on-small-only>Channels</span></a></li><li ui-sref-active=channel-tab-highlight ui-sref=home.channelPage.about class="waves-effect waves-block waves-light tab channel-tab-bg"><a class=white-text><i class="material-icons channel-tab-icons">info_outline</i> <span class=hide-on-small-only>About</span></a></li></ul></div></div><div class=channel-tab-content ng-class=channelTabContent ui-view></div>'),a.put("src/js/modules/channelPage/channelPageAbout/channelPageAbout.html",'<div ng-init=init()><div class=row><div class="col s12"><div class=card><div class="grey lighten-4 card-content"><span class=card-title><strong style="font-weight: 400">Description</strong></span><p class=channel-description>{{::channel.snippet.description}}</p></div><div class="grey lighten-2 row card-action"><div class="col s12 m6 l3"><i class="material-icons channel-tab-icons">date_range</i> <strong>Joined: </strong>{{::channel.snippet.publishedAt}}</div><div class="col s12 m6 l3"><i class="material-icons channel-tab-icons">sort</i> <strong>Total Views: </strong>{{::channel.statistics.viewCount}}</div><div class="col s12 m6 l3"><i class="material-icons channel-tab-icons">subscriptions</i> <strong>Subscribers: </strong>{{::channel.statistics.subscriberCount}}</div><div class="col s12 m6 l3"><i class="material-icons channel-tab-icons">video_library</i> <strong>Videos: </strong>{{::channel.statistics.videoCount}}</div></div></div></div></div></div>'),a.put("src/js/modules/channelPage/channelPageChannels/channelPageChannels.html",'<div ng-init=init()><div class=row><div class="col s12 row"><br><span style="font-size:24px;position: relative; left: 10px;max-width: calc(100% - 12px)">{{::channel.brandingSettings.channel.featuredChannelsTitle}}</span><br><a ui-sref="home.channelPage.home({id: featuredChannel.id})" class="col s4 m3 l2" ng-repeat="featuredChannel in featuredChannels"><div class=card><div class="card-image waves-effect waves-block waves-light"><img ng-src={{::featuredChannel.snippet.thumbnails.medium.url}}></div><div class=card-content style="padding-left: 10px;padding-right: 10px"><span class="truncate grey-text text-darken-4">{{::featuredChannel.snippet.title}}</span></div></div></a><div ng-if=loaderFeatured class="col s12 center"><spinner></spinner><br></div><div ng-hide="featuredChannels || loaderFeatured" class=center style="margin: 30px 0px 10px 0px"><i class="material-icons channel-tab-icons">error</i> <span>No Featured Channels Available</span></div></div><div class="col s12 row" ng-if=subscriptionsAllowed><span style="font-size:24px;position: relative; left: 12px;max-width: calc(100% - 12px)">Subscriptions</span><br><a ui-sref="home.channelPage.home({id: subscribedChannel.snippet.resourceId.channelId})" class="col s4 m3 l2" ng-repeat="subscribedChannel in subscribedChannels"><div class=card><div class="card-image waves-effect waves-block waves-light"><img ng-src={{::subscribedChannel.snippet.thumbnails.medium.url}}></div><div class=card-content style="padding-left: 10px;padding-right: 10px"><span class="truncate grey-text text-darken-4">{{::subscribedChannel.snippet.title}}</span></div></div></a><div ng-if=loaderSubscribed class="col s12 center"><spinner></spinner><br></div><div ng-hide="subscribedChannels || loaderSubscribed" class=center style="margin: 30px 0px 10px 0px"><i class="material-icons channel-tab-icons">error</i> <span>No Channels Subscribed</span></div></div></div></div>'),a.put("src/js/modules/channelPage/channelPageHome/channelPageHome.html","<div ng-init=init() class=row ng-class=mobilePaddingMargin></div><video-carousel channel-id=channelId order=recent></video-carousel><video-carousel channel-id=channelId order=mostPopular></video-carousel>"),a.put("src/js/modules/channelPage/channelPageVideos/channelPageVideos.html",'<div class=row ng-init=init()><br><span style="font-size:24px;position: relative; left: 8px;max-width: calc(100% - 12px)">Uploaded Videos</span><br><div class="col s6 m3 l3" ng-repeat="video in videos track by $index"><video-item video-detail=videoDetails[$index] video=video hide-channel=true></video-item></div><div ng-if=loaderVideos class="col s12 center"><spinner></spinner><br></div><div class="col s12 center"><button class=btn ng-if=nextPageToken ng-click=loadMoreVideos()>Load More Videos</button></div><div ng-show="!videos.length && !loaderVideos" class=center style="margin: 30px 0px 10px 0px"><i class="material-icons channel-tab-icons">error</i> <span>No Videos Available</span></div></div>'),a.put("src/js/modules/header/header.html",'<div class=navbar-fixed ng-init=init()><nav class="red darken-3" role=navigation><div class="nav-wrapper container"><i ng-class=mobileSearchFocus class="material-icons waves-effect waves-light" style="display:inline-block; position: relative; left:-10px; cursor: pointer; transition:transform .5s ease" ng-click=toggleSidenav()>menu</i> <a ng-class=mobileSearchFocus ui-sref=home.homePage class="brand-logo youtube-logo"></a><ul class=height-100 ng-class=search_ul><li class="height-100 search-item-li" ng-class=search_li><div class=height-100><label for=search><i class="material-icons search-item-input-icon">search</i> <span ng-show=tinySpinner class="tiny-spinner right"></span></label><input ng-trim=false ng-focus=searchFocused() class=search-item-input id=search ng-model=query ng-blur=searchBlured() ng-change=fetchSearchSuggestion() ng-keydown=inputKeypress($event) placeholder=Search... autocomplete=off autocorrect=off autocapitalize=off spellcheck=false></div><div style="overflow: auto;\r\n    max-height: calc(100vh - 57px)" ng-show="searchSuggestion && query && items" class="collection suggestion"><a ng-class="(selectedIndex==$index)?\'suggestion-item-hover\':\'\'" ng-repeat="item in items[1]" ng-mousedown=suggestionClick(item) ng-mouseover=mouseOver($index) class=collection-item>{{item}}</a></div></li><li class="pointer hide-on-med-and-up" ng-show=crossSign ng-mousedown="query=\'\'"><i class=material-icons>close</i></li></ul></div></nav></div>'),a.put("src/js/modules/homePage/homePage.html",'<video-carousel category=videoCategories ng-repeat="videoCategories in videoCategories"></video-carousel>'),a.put("src/js/modules/searchVideos/searchVideos.html",'<br ng-init=init()><div class=search-page-margin><div class=center ng-if=preloader><spinner></spinner></div><div class=row ng-if=videos><div class="col s6 m3 l3" ng-repeat="video in videos"><video-item video=video video-detail=videoDetails[$index]></video-item></div></div><div class=row><div class="col s12"><button class="btn waves-effect waves-light max-width-50" name=action ng-if=prevPageToken ng-click=nextOrPrev(prevPageToken)>Previous <i class="material-icons right">navigate_before</i></button> <button class="btn waves-effect waves-light right max-width-50" name=action ng-if=nextPageToken ng-click=nextOrPrev(nextPageToken)>Next <i class="material-icons right">navigate_next</i></button></div></div></div>'),a.put("src/js/modules/sidenav/sidenav.html",'<div ng-swipe-left=toggleSidenav() class=mobile-sidenav-overlay ng-show="(isMobile || isTablet) && isSideNavOn" ng-click=toggleSidenav()></div><div ng-init=init() ng-class=sidenavLeft style="float:left; background-color:white; width:220px; height:100%; position: fixed; z-index: 10; overflow:auto; height:calc(100% - 56px); top: 56px; box-shadow:0 2px 5px 0 rgba(0,0,0,0.16),0 2px 10px 0 rgba(0,0,0,0.12)"><ul style="margin-top: 10px"><li ui-sref=home.homePage ng-click="(isMobile || isTablet) && toggleSidenav()" class="li-side waves-effect waves-teal pointer"><i class="material-icons channel-tab-icons red-text">home</i>Home</li><li ui-sref-active="grey lighten-4" ui-sref="home.trending({category: \'\',pageToken:\'\'})" ng-click="(isMobile || isTablet) && toggleSidenav()" class="li-side waves-effect waves-teal pointer"><i class="material-icons channel-tab-icons green-text">trending_up</i>Trending</li><li class=divider></li><li ui-sref-active="grey lighten-4" ui-sref="home.trending({category: \'music\',pageToken:\'\'})" ng-click="(isMobile || isTablet) && toggleSidenav()" class="li-side waves-effect waves-teal pointer"><i class="material-icons channel-tab-icons orange-text">music_video</i>Music</li><li ui-sref-active="grey lighten-4" ui-sref="home.trending({category: \'movies\',pageToken:\'\'})" ng-click="(isMobile || isTablet) && toggleSidenav()" class="li-side waves-effect waves-teal pointer"><i class="material-icons channel-tab-icons teal-text">movie</i>Movies</li><li ui-sref-active="grey lighten-4" ui-sref="home.trending({category: \'sports\',pageToken:\'\'})" ng-click="(isMobile || isTablet) && toggleSidenav()" class="li-side waves-effect waves-teal pointer"><i class="material-icons channel-tab-icons purple-text">directions_run</i>Sports</li><li ui-sref-active="grey lighten-4" ui-sref="home.trending({category: \'technology\',pageToken:\'\'})" ng-click="(isMobile || isTablet) && toggleSidenav()" class="li-side waves-effect waves-teal pointer"><i class="material-icons channel-tab-icons cyan-text">devices_other</i>Technology</li><li ui-sref-active="grey lighten-4" ui-sref="home.trending({category: \'comedy\',pageToken:\'\'})" ng-click="(isMobile || isTablet) && toggleSidenav()" class="li-side waves-effect waves-teal pointer"><i class="material-icons channel-tab-icons brown-text">insert_emoticon</i>Comedy</li><li ui-sref-active="grey lighten-4" ui-sref="home.trending({category: \'education\',pageToken:\'\'})" ng-click="(isMobile || isTablet) && toggleSidenav()" class="li-side waves-effect waves-teal pointer"><i class="material-icons channel-tab-icons pink-text">school</i>Education</li><li class=divider></li><li ui-sref-active="grey lighten-4" ui-sref=home.about ng-click="(isMobile || isTablet) && toggleSidenav()" class="li-side waves-effect waves-teal pointer"><i class="material-icons channel-tab-icons pink-text">info_outline</i>About</li></ul></div>'),a.put("src/js/modules/trendingPage/trendingPage.html",'<br ng-init=init()><div class=search-page-margin><span style=font-size:24px>{{::title}}</span><div class=center ng-if=loader><spinner></spinner></div><div class=row ng-if=videos><div class="col s6 m3 l3" ng-repeat="video in videos"><video-item video=video video-detail="{statistics: video.statistics, contentDetails : video.contentDetails}"></video-item></div></div><div class=row><div class="col s12"><button class="btn waves-effect waves-light max-width-50" name=action ng-if=prevPageToken ng-click=nextOrPrev(prevPageToken)>Previous <i class="material-icons right">navigate_before</i></button> <button class="btn waves-effect waves-light right max-width-50" name=action ng-if=nextPageToken ng-click=nextOrPrev(nextPageToken)>Next <i class="material-icons right">navigate_next</i></button></div></div></div>'),a.put("src/js/modules/videoPage/videoPage.html",'<div ng-show=barModeAfterSlide ng-class="{\'ui-view-margin-adjust\' : barModeAfterSlide && video}" ui-view></div><div ng-init=init()><div ng-show="barModeAfterSlide && video" ng-class="{\'video-bar-padding\':isSideNavOn}" class=video-bar><span ui-sref="home.videoPage({id: videoId})"><img class=thumbnail src={{video.snippet.thumbnails.medium.url}}><div class="video-title truncate">{{video.snippet.title}}</div><div class="channel-title truncate">{{channel.snippet.title}}</div><div class="channel-title truncate">{{video.currentTime}} / {{video.contentDetails.duration}}</div></span><div class=progress-bar-bg ng-class="{\'adjust-width\' : isSideNavOn}"><div ng-style=bufferBarWidth class="progress-bar buffered"></div><div ng-style=progressBarWidth class=progress-bar></div></div><i ng-show=!isBuffering ng-click=playPauseVideo() class="material-icons play-pause-btn">{{isPlaying?\'pause_circle_filled\':\'play_circle_filled\'}}</i><spinner ng-show=isBuffering></spinner></div><div ng-class="{\'slide-up-video-page\' : !barMode, \'slide-down-video-page\' : barMode, \'hide\' : barModeAfterSlide}" class="row transform-transition"><div class="col l8 m9 s12" ng-class=mobilePaddingMargin><div class="col s12" ng-class=mobilePaddingMargin><div class=card ng-class=mobilePaddingMargin><div class=card-image><div class=embed-container><youtube-video state-change-callback=onPlayerStateChange video-id={{videoId}} player=player></youtube-video></div></div><ul id=videoInfo class="collapsible zero-margin video-accordion"><li class=active><ul class="collapsible-header zero-padding" style="cursor: initial"><li style="padding: 0px 10px"><h5>{{video.snippet.title}}</h5></li><li class=divider></li><li style="padding: 11px 10px"><a ui-sref="home.channelPage.home({id: video.snippet.channelId})" class="chip channel-chip-video-page" style="max-width: 50%"><img ng-src={{channel.snippet.thumbnails.default.url}}> <span class=truncate>{{channel.snippet.title}}</span></a><div class=right><strong style="top:-17px; position:relative">{{video.statistics.viewCount }} Views</strong><div ng-if="likeCount+dislikeCount==0" style="z-index:9;height: 3px; background-color: grey; position: relative; top: -24px"></div><div ng-if="likeCount+dislikeCount!=0" ng-style=dislikeWidth style="z-index:9;height: 3px; background-color: red; position: relative; top: -24px"></div><div ng-if="likeCount+dislikeCount!=0" style="height: 3px; background-color: green; position: relative; top: -27px"></div><div style="display:inline-block; position:relative; top:-32px"><i class=material-icons style="margin-right: 2px">thumb_down</i>{{dislikeCount | number}}</div><div style="display: inline-block; position:relative; top:-32px"><i class=material-icons style="margin-right: 2px;  margin-left: 5px">thumb_up</i>{{likeCount | number}}</div></div></li></ul><div class=collapsible-body style=display:block><blockquote><strong>Uploaded: {{uploadedTime}}</strong></blockquote><p class=video-description ng-class=description ng-bind-html=video.snippet.descriptionHTML></p><div class=expand-description-button ng-if=isExpandable ng-click=expandDescription()><div>{{expandDescriptionBar}}</div></div></div></li></ul></div></div><div ng-if=commentsEnabled scroll-fire="sortComments(\'relevance\')" class="col s12" style="margin-top: 10px; margin-bottom: 5px; text-align: center"><input class=with-gap name=comments ng-click="order!=\'relevance\'?sortComments(\'relevance\'):return" type=radio id=relevance checked><label for=relevance>Top Comments</label><input class=with-gap name=comments ng-click="order!=\'time\'?sortComments(\'time\'):return" type=radio id=time><label for=time>Newest First</label></div><div ng-if=commentsEnabled class="col s12" style="margin-bottom: 10px"><ul class="card collection" style="margin-bottom: 0px"><comment comment=comment ng-repeat="comment in comments.items track by comment.id"></comment><div ng-if="!commentsLoader && comments.nextPageToken" class=expand-description-button ng-click=loadMoreComments(comments.nextPageToken)>Load More Comments</div></ul><div ng-if=commentsLoader class=progress style="margin-top: 0px"><div class=indeterminate></div></div></div><div ng-if=!commentsEnabled class="col s12 card" style="line-height: 3; text-align: center">Comments have been disabled on this video.</div></div><div scroll-fire=loadRelatedVideos() class="col l4 m3 s12 zero-padding"><div class=row><video-item class="col s6 m12 l6" video=video video-detail=videoDetails[$index] channel=channels[$index] ng-repeat="video in relatedVideos track by $index"></video-item></div><div ng-if=loaderVideos class="col s12 center"><spinner></spinner><br></div><div class="col s12 center"><button class=btn ng-show=nextPageToken ng-click=loadMoreVideos()>Load More Videos</button></div></div></div></div>');
}]);